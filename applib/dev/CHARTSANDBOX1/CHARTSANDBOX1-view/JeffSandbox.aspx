<!-- foo -->
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JeffSandbox.aspx.cs" ValidateRequest="false" Inherits="dev_JeffSandbox" %>
          ...
          <ng-legacy-container class="content">
              <div style="position:relative;height:100%;width:100%;">
                ...
                <div style="position:absolute; top: 0px; left: 0px; width: 100%; height: 100%;">
                  <ng-acuity-report text="Drill Test" details="..Details"
                        hidetopper="NOTtrue" filters="StartDate=8/1/2018&EndDate=10/15/2018" cid="Test-TopDrillableTable" cidclient="all">
                  </ng-acuity-report>
                </div>
                <!--
