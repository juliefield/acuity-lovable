...
public partial class dev_ChartSandbox : SitePage
{
...
//            Session("TP1Role") = Request.QueryString("role").ToString
        ...
        {
            String redirect = "~/applib/dev/LOGIN1/LOGIN1-view/loginNew.aspx?url=../../../../applib/dev/CHARTSANDBOX1/CHARTSANDBOX1-view/ChartSandbox.aspx";
