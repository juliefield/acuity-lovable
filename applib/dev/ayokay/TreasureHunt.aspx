<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="TreasureHunt.aspx.cs" EnableTheming="false" StylesheetTheme="AcuityMV" Theme="" ValidateRequest="false" Inherits="appHelloWorld_default" %>
...
<asp:PlaceHolder runat="server">
    ...
    <script type="text/javascript" src="../../lib/anothercolorpicker/src/jquery.simple-color.js"></script>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="css/treasurehunt.css"  />
    <script type="text/javascript" src="js/viewmodels/treasurehunt.js"></script>
...
<body>
    <div class="app-header gradient-lightest">
        ...
        <div class="app-heading">Treasure Hunt!</div>
        <div class="app-header-tile">
            <div class="err-icon">
            </div>
        </div>
        <!-- #Include virtual="../../html/views/login.htm" -->
    ...
    <div class="content">
        ...
        <div class="auth-show" style="display:none;padding-top: 8px;" >
            <!-- #Include virtual="html/views/treasurehunt.htm" -->
        </div>
    </div>
</body>
</html>