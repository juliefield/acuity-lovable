...
(function () {
            ...
            $(xml).find(which + 's').each(function () {
                ...
                $(this).find(which).each(function () {
                    if (pj == "") {
                        ...
                        addit = false;
                        for (var i in pjs) {
                            if ($(this).find("desc").text()==pjs[i]) {
                                addit = true;
                                break;
                            }
                        }
                    }
                    //DEBUG: TEST for the project.  This may be where it fails when project is ambiguous.
    ...
    function showprogress(id) {
        ...
        $("#loadingprompt").show();
        //tmr = window.setTimeout('window.appApmClient.showloadingprompt()', 100);
    }
    /*
    ...
    */
    ...
    function hideprogress(id) {
        ...
        $("#loadingprompt").hide();
        //tmr2 = window.setTimeout('window.appApmClient.hideloadingprompt()', 100);
    }
    /*
    ...
    */
    ...
    window.appApmClient = {
        ...
        //showloadingprompt: showloadingprompt,
        //hideloadingprompt: hideloadingprompt,
        download: download
    };
