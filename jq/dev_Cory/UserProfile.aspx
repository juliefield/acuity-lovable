...
<asp:PlaceHolder runat="server">
    ...
    <script type="text/javascript" src="js/libs/ko.mapping.js"></script>
...
<body>
    <div class="app-header gradient-lightest">
        ...
        <div class="login-form">
            <form id="loginForm" action="#">
                ...
                <div><input id="loginbutton" type="button" value="log in" data-bind="click: doLogin" /></div>
    ...
    <div class="content">
        ...
        <div class="auth-show" style="display:none;" >
            ...
            <div class="pure-menu pure-menu-open pure-menu-horizontal" id="userSelection" >
                <!-- <div class="pure-menu-heading" >
                        <label for="userSelect">Select a User</label>
                        <select data-bind="options: availableUsers, value: selected, event: { change: userChanged }" id="userSelect"></select>
                </div> -->
                ...
                <div class="pure-menu-heading">
                    <label for="userSelect">Select A User</label>
                    <select data-bind="options: user, optionsText: 'text', optionsValue: 'val', optionsCaption: '- none -', value: selected, event: { change: userChanged }, chosen: {} " id="userSelect"></select>
                </div>
