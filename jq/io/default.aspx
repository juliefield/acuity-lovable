<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="default.aspx.cs" EnableTheming="false" StylesheetTheme="AcuityMV" Theme="" ValidateRequest="false" Inherits="io_default" %>
...
<asp:PlaceHolder runat="server">
    ...
    <script type="text/javascript" src="../../applib/minify/minify.json.js"></script>
    ...
    <script type="text/javascript" src="js/viewmodels/iowrapper-0.1.js"></script>
...
<body>
    <div class="app-header gradient-lightest">
        ...
        <div class="app-heading">IO Tester</div>
    ...
    <div class="content">
        ...
        <div class="auth-show" style="display:none;padding-top: 8px;" >
          <!-- #Include virtual="html/views/iowrapper.htm" -->
        </div>
    </div>
