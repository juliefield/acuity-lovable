<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_TravelCall_Prototype.aspx.cs" ValidateRequest="false" Inherits="_Monitor_TravelCall_Prototype" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Travel Call QA</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Travel Call Quality Form<span style="font-weight:20px;color:Red;display:none;">&nbsp;&nbsp;DO NOT USE - THIS MONITOR IS IN DEVELOPMENT!</span></div>
    </div>
    ...
    <div class="mon-wrapper">
        ...
        <div class="mon-content">
          ...
          <ol>
             <li>
                 <span class="mon-question">Introduction</span>
              ...
              <li>
                  <span class="mon-question">Interpersonal Skills</span>
              ...
              <li>
                  <span class="mon-question">Positive Framing</span>
              ...
              <li>
                  <span class="mon-question">Call Close</span>
          ...
          <ol start="6">
              <li>
                  <span class="mon-question">Product or Promotion Handling</span>
              ...
              <li>
                  <span class="mon-question">Insurance Eligibility</span>
              ...
              <li>
                  <span class="mon-question">Owner Education</span>
          ...
          <div class="mon-section">Sales Skill</div>
          <ol start="9">
              <li>
                  <span class="mon-question">Understanding Customer Needs</span>
              ...
              <li>
                  <span class="mon-question">Sales Presentation</span>
              ...
              <li>
                  <span class="mon-question">Upselling</span>
              ...
              <li>
                  <span class="mon-question">Preferred Supplier Focus/Presentation</span>
              ...
              <li>
                  <span class="mon-question">Offering Alternatives</span>
              ...
              <li>
                  <span class="mon-question">Overcoming Objections</span>
              ...
              <li>
                  <span class="mon-question">Insurance Offer Quality</span>
              ...
              <li>
                  <span class="mon-question">Insurance Close</span>
              ...
              <li>
                  <span class="mon-question">Quality Recap</span>
