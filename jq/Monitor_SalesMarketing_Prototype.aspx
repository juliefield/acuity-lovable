            ...
            <ul class="mon-fields">
                ...
                <li class="mon-field" ><label>Call&nbsp;Party&nbsp;Type</label>
                    <select id="selCallpartyType" runat="server"><option value="">--select--</option>
                        ...
                        <option value="Bookvip">Bookvip</option>
      ...
      $(".error-category").bind("change", function () {
          ...
          switch ($(this).val()) {
              ...
              case "Agent Performance":
                  opts = ["Disposition","Request to CXL/Refund","Call Recording Statement","False Claims","Another Account","Incorrect Offer", "Pitch vs. Offer", "Checklist Error", "Missing Genie", "Welcome Center"];
                  break;
              default:
