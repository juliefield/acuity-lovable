<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TP1ReportTable.aspx.cs" ValidateRequest="false" Inherits="jq_TP1ReportTable" %>
...
<body id="ReportTable" runat="server" style="position: relative;">
  ...
  <div id="container">
   <div id="header"><div id="brandingLogo"><h1><span>ERS</span></h1></div></div><div id="nav">
        <ul id="header_ul"><li><a onclick="return appLib.prefixhref(this);" href="http://acuityapm.com/default.aspx">Dashboard</a></li>
        <li id="header_liActive"><a id="header_active" onclick="return appLib.prefixhref(this);" href="TP1ReportsMenu">Reports</a></li>
        </div>
        <div id="header_logout"><span>Welcome</span> <span id="header_userID_lbl"></span><span>&nbsp;| <a onclick="return appLib.prefixhref(this);" href='http://acuityapm.com/logout.aspx' title='Logout'>Logout</a></span><span style="color:gray;">&nbsp;&nbsp;v2</span><div id="loadingprompt" style="color:White;background-color:#EF4521;padding-top:4px;padding-bottom:2px;padding-left:20px;font-weight:bold;font-size:16px;padding-right: 20px;float:right;">Loading...</div></div>
        <div id="sidebar"><div class="sidebarNav" id="ReportSidebar">
        <ul id="sidebar_ulMain">
    <ul id="sidebar_ulLevel1">
        <li id="sb_sr"><a class="liHeader" href="reportsmenu.aspx?cid=KPI&sb=sr">KPI Scorecard</a> 
        </li>
        <li id="sb_qe"><a class="liHeader" href="QualityDashboard.aspx?sb=qe">Quality</a> 
        </li>
        <li id="sb_qz"><a class="liHeader" href="reportsmenu.aspx?cid=Quiz">Quiz</a> 
        </li>
    </ul>
</ul>
