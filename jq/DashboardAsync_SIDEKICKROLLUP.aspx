<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardAsync.aspx.cs" ValidateRequest="false" Inherits="jq_DashboardAsync" %>
    ...
    <![endif]-->
		...
		<asp:PlaceHolder runat="server">
			<link href="appApmClient/themes/default/theme-1.1.css" type="text/css" rel="stylesheet" />
			...
			<script type="text/javascript" src="appApmClient/js/appApmReport-1.1.0.js"></script>
        ...
        -->
			...
			<script type="text/javascript" src="../appLib/js/viewmodels/fan-2.5.js"></script>

			<!-- Files with separate JulieDev replacements  -->
			<link rel="stylesheet" type="text/css" media="all" href="../applib/css/base.css" />
			<link rel="stylesheet" type="text/css" media="all" href="../applib/css/fan-2.5.css" />
				...
				<div id="appdiv" class="content">
					...
					<div class="leftpanel">
						...
						<div id="filterdiv" class="filters panelbox" style="clear: left; z-index:100; width: 270px; height:auto; position:relative; overflow:visible;">
                            <div id="teamrank" style="display:none;position:relative;text-align: center; font-size: 13px; /*color:Black;*/color:White;font-weight: bold;padding: 10px;padding-bottom: 15px;">
                                Place team rank here.
                            </div>
                            <div id="shiftbid" style="display:none;position:relative;text-align: center; font-size: 13px; /*color:Black;*/color:White;font-weight: bold;padding: 10px;padding-bottom: 15px;">
            ...
            -->
					...
					<div class="tabs" id="tabs">
						...
						<div id="tabs-1" style="background-color: #fff;">
							<div class="tabarea">
							    <div class="home-show-wrapper stg-field" style="z-index:1;"><label id="ReportGroupingLabel">Show:</label><span id="HomeReportList" class="stg"></span></div>
                                ...
                                <div class="report-menu-wrapper">
							        <div class="report-show-wrapper stg-field">
                                        ...
                                        <span id="ReportReportList" class="stg">
                                            <select data-placeholder="Select Report" style="max-width: 250px;"><option value=""></option></select>
                                        </span>
                                    </div>
                    ...
                    <select style="display:none;">
						...
						<div id="tabs-15">
							<div class="subtabs" id="tabsattrition">
								<ul>
									...
									<li><a class="tablabel attrition-reports-link" href=".AttritionLedger-wrapper">Reports</a></li>
								</ul>
							</div>
                        ...
                        <div id="tabs-guide">
                            <div class="tabarea">
                                <iframe sandbox="allow-popups allow-popups-to-escape-sandbox" src="../applib/html/guides/chime-start-guide/index.html?a6" id="GuideIframe" name="myguideframe" style="border:0px; width: 1200px;  height: 100%" ></iframe>
                            </div>
                        </div>
                        ...
                        <div id="tabs-attendanceform">
                            <div class="tabarea">
                                <p class="attendanceform-message">Please select a CSR (use the filters on the left).</p>
                        ...
                        <div id="tabs-journalform" style="width: 100%; height: 100%;">
                            <div class="tabarea tabarea-journal" style="width: 100%; height: 100%;">
                                ...
                                <p class="journalform-message">Please select a CSR (use the filters on the left).</p>
					...
					<script type="text/javascript">
						    ...
						    pagecontrols: [{
								...
								},
								{
								    ...
								    onchange: function () {
								        ...
								        ko.postbox.publish("JournalProject", $("#selProjects").val());
								...
								},
								{
								    ...
								    onchange: function () {
								        ...
								        ko.postbox.publish("JournalLocation", $("#selLocations").val());
								        appApmDashboard.refreshboxes({
								...
								},
								{
								    ...
								    onchange: function () {
								        ...
								        ko.postbox.publish("JournalGroup", $("#selGroups").val());
								        appApmDashboard.refreshboxes({
								            which: 'Team,CSR',
								            success: function () {
								                appApmMessaging.composecontacts();
                        ...
                        $(document).ready(function () {
                            ...
                            */
                            ...
                            //MAKEDEV
                            if ((a$.urlprefix() == "ers.") || ((a$.urlprefix() == "ces.") || (a$.urlprefix() == "ces-demo.")) || (a$.urlprefix() == "chime.") || (a$.urlprefix() == "chime-make40.") || (a$.urlprefix() == "chime-mnt.") || (a$.urlprefix() == "cox.") || (a$.urlprefix() == "performant.")) {
                            ...
                            if (((a$.urlprefix() == "ers.") || (a$.urlprefix() == "ers-mnt.") || (a$.urlprefix() == "act.") || (a$.urlprefix() == "act-mnt.") || (a$.urlprefix() == "km2.") || (a$.urlprefix() == "cox.") || (a$.urlprefix() == "v3.") || (a$.urlprefix().indexOf("make.") >= 0) || (a$.urlprefix().indexOf("make40.") >= 0)) && ($.cookie("TP1Role") != "CSR")) {
                            ...
                            */
                            ...
                            if ((a$.urlprefix() == "cox.") || (a$.urlprefix() == "cox-test.") || (a$.urlprefix() == "cox-mnt.")) {
                                $("#GuideIframe").attr("src", "../applib/html/guides/cox-start-guide/index.html?atest=70-");
                                $("#guidetab").show();
                            }
                            if ((a$.urlprefix() == "frost-arnett.") || (a$.urlprefix() == "frost-arnett-test.") || (a$.urlprefix() == "frost-arnett-mnt.")) {
                            ...
                            if ((($.cookie("TP1Role") == "Admin") || ($.cookie("TP1Role") == "CorpAdmin")) ||
                                ...
                                $(".easycom-editor a").attr("href", "https://" + a$.urlprefix().split(".")[0] + "-v3.acuityapm.com/applib/dev/LOGIN1/LOGIN1-view/loginNew.aspx?url=/3/Easycom.aspx");
                                $(".easycom-editor").show();
                            }
                            //MAKEDEV
                            if ((((a$.urlprefix() == "ces.")
                                ...
                                function checkcomplianceiframe(json) {
                                    if (false) { //(a$.jsonerror(json)) {
                                        ...
                                        if (json.iframeAllowed) {
                                            ...
                                            //$("#ComplianceformIframe").attr("src", "https://ces-v3" + ((a$.urlprefix() == "ces-v3-shell.") ? "-dev" : "") + ".acuityapm.com/3/Touchpointauthentication.aspx?url=../3/ComplianceFormCES.aspx&username=" + $.cookie("TP1Username") + "&uid=" + $.cookie("uid") + "&role=" + $.cookie("TP1Role") + "&roleset=&project=1&CSR=").show();
                                            //New way (with list)
                                            $(".compliance-system a").attr("href", "https://performant-v3-dev.acuityapm.com/applib/dev/LOGIN1/LOGIN1-view/loginNew.aspx?url=/3/ComplianceFormPerformant.aspx?origin=v2");
                                            $(".compliance-system").show();
                                        }
                                    }
                                }
                                ...
                                ko.postbox.subscribe("CSR", function (newValue) {
                                    if (newValue != mycsr) {
                                        if ((newValue == "") || (newValue == "each")) {
                                            ...
                                            mycsr = newValue;
                                            $("#AttendanceformIframe").attr("src", "https://bgr-v3" + ((a$.urlprefix() == "bgr-v3-shell.") ? "-dev" : "") + ".acuityapm.com/3/Touchpointauthentication.aspx?url=../3/AttendanceFormBGR.aspx&username=" + $.cookie("TP1Username") + "&uid=" + $.cookie("uid") + "&role=" + $.cookie("TP1Role") + "&roleset=&project=1&CSR=" + mycsr).show();
                                        }
                                    }
                                });
                            }
                            ...
                            if (((a$.urlprefix() == "bgr.") || (a$.urlprefix() == "bgr-test.") || (a$.urlprefix() == "bgr-v3-shell.") || (a$.urlprefix() == "NOTbgr-mnt.") || (a$.urlprefix() == "bgr-make40.")) && (($.cookie("TP1Role") != "CSR")) /* && (($.cookie("TP1Role") == "Admin")||($.cookie("TP1Role") == "CorpAdmin"))  */) {
                                ...
                                ko.postbox.subscribe("CSR", function (newValue) {
                                    if (newValue != mycsr2) {
                                        if ((newValue == "") || (newValue == "each")) {
                                            ...
                                            mycsr2 = newValue;
                                            $("#JournalformIframe").attr("src", "https://bgr-v3" + ((a$.urlprefix() == "bgr-v3-shell.") ? "-dev" : "") + ".acuityapm.com/3/Touchpointauthentication.aspx?url=../3/JournalFormBGR.aspx&username=" + $.cookie("TP1Username") + "&uid=" + $.cookie("uid") + "&role=" + $.cookie("TP1Role") + "&roleset=&project=1&CSR=" + mycsr2).show();
                                        }
                                    }
                                });
                            }
                            else if (a$.urlprefix().indexOf("-mnt") >= 0) {
                                $("#journalformtab").show();
                                $(".journalform-message").hide();
                                var mycsr2 = "badval";
                                var myteam2 = "badval";
                                var mygroup2 = "badval";
                                var mylocation2 = "badval";
                                var myproject2 = "badval";
                                ...
                                ko.postbox.subscribe("JournalGroup", function (newValue) {
                                    //alert("debug: changed CSR");
                                    if (newValue == "each") newValue = "";
                                    if (newValue != mygroup2) {
                                        mygroup2 = newValue;
                                        callJournalFrame();
                                    }
                                });
                                ko.postbox.subscribe("JournalLocation", function (newValue) {
                                    //alert("debug: changed CSR");
                                    if (newValue == "each") newValue = "";
                                    if (newValue != mylocation2) {
                                        mylocation2 = newValue;
                                        callJournalFrame();
                                    }
                                });
                                ko.postbox.subscribe("JournalProject", function (newValue) {
                                    //alert("debug: changed CSR");
                                    if (newValue == "each") newValue = "";
                                    if (newValue != myproject2) {
                                        myproject2 = newValue;
                                        callJournalFrame();
                                    }
                                });
                                function callJournalFrame() {
                                    ...
                                    //Chris dev mode
                                    var dev = "https://" + a$.urlprefix().substring(0, a$.urlprefix().indexOf("-")) + "-v3-dev.acuityapm.com/3/Touchpointauthentication.aspx?url=../3/JournalForm.aspx|dev=1&username=" + $.cookie("TP1Username") + "&uid=" + $.cookie("uid") + "&role=" + $.cookie("TP1Role") + "&roleset=&Project=" + myproject2 + "&Location=" + mylocation2 + "&Group=" + mygroup2 + "&Team=" + myteam2 + "&CSR=" + mycsr2;
                                ...
                                ko.postbox.subscribe("CSR", function (newValue) {
                                    if (newValue != mycsr2) {
                                        if ((newValue == "") || (newValue == "each")) {
                                            ...
                                            $(".journalform-message").hide();
                                            mycsr2 = newValue;
                                            $("#JournalformIframe").attr("src", "https://" + a$.urlprefix().substring(0, a$.urlprefix().indexOf(".")) + "-v3-dev.acuityapm.com/3/Touchpointauthentication.aspx?url=../3/JournalForm.aspx" + ((($.cookie("TP1Username").toLowerCase() == "jeffgack") || ($.cookie("TP1Username").toLowerCase() == "dweather")) ? "|dev=1" : "|nodev=0") + "&username=" + $.cookie("TP1Username") + "&uid=" + $.cookie("uid") + "&role=" + $.cookie("TP1Role") + "&roleset=&project=1&CSR=" + mycsr2 + "&Team=" + $("#selTeams").val()).show();
                                        }
                                    }
                                });
                            }

                            if ((a$.urlprefix() == "chime-mnt.")) {
                                $("#reviewformtab").show();
                                var myteam = "";
                                var mycsr = "";
                                var myhash = "";
                                ...
                                function callSupPerf() {
                                    if ((myteam == "") || (myteam == "each") || (mycsr == "each")) {
                                        ...
                                        dev = "https://chime-v3-dev-chris" + ((a$.urlprefix() == "bgr-v3-shell.") ? "-dev" : "") + ".acuityapm.com/3/Touchpointauthentication.aspx?url=../3/Supperfmgt.aspx|CSR=" + mycsr + "~Team=" + myteam + myhash + "&username=" + $.cookie("TP1Username") + "&uid=" + $.cookie("uid") + "&role=" + $.cookie("TP1Role") + "&roleset=&project=1";
