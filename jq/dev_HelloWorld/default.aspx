...
<asp:PlaceHolder runat="server">
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="css/helloworld.css"  />
    <script type="text/javascript" src="js/viewmodels/helloworld.js"></script>
...
<body>
    <div class="app-header gradient-lightest">
        ...
        <div class="app-heading">Hello World!</div>
    ...
    <div class="content">
        ...
        <div class="auth-show" style="display:none;padding-top: 8px;" >
            <!-- #Include virtual="html/views/helloworld.htm" -->
        </div>
    </div>
</body>
</html>