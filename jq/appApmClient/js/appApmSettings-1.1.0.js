...
(function () {
    ...
    function init(o) {
        ...
        if (o.id == o.shadow) o.shadow = false; //Added 2019-10-15
        if (o.shadow) {
        ...
        if (o.ui == "slider") {
            ...
            $("#" + o.id + " ." + o.shadow).slider().bind("slidechange", function (event, ui) {
                if (!KILLPROP) stgsettingchange(this, true);
            });

            $("#" + o.id + " ." + o.shadow).slider().bind("click", function (event, ui) {

                $(this).slider("value", $(this).slider("value"));
                return;

                $("#" + o.id + " ." + o.shadow).slider("destroy");
                $("#" + o.id + " .stg-steps").remove();
                $("#" + o.id + " ." + o.shadow).remove();
                $("#" + o.id + " .stg-label").remove();
                init(o);
                /*
                $("#" + o.id + " ." + o.shadow).slider().unbind("slidechange").bind("slidechange", function (event, ui) {
                if (!KILLPROP) stgsettingchange(this, true);
                });
                */
