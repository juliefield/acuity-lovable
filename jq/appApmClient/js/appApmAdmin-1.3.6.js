...
(function () {
    ...
    function buildalerteditor(o) {
        ...
        if (!cph) {
            ...
            if ((a$.urlprefix() != "ers.")) {
                if (o.hasraw) {
                    b += '<option value="Raw Score">Standard Value</option>';
                }
            }
        }
        else {
        ...
        if (cph) {
            ...
            for (var i in ad.model[o.m].project[o.p].kpi) {
                if (ad.model[o.m].project[o.p].kpi[i].desc == "AHT") {
                    for (var j in ad.model[o.m].project[o.p].kpi[i].subkpi) {
    ...
    function buildkpiarea(m, p, k, s) {
        ...
        if (ad.model[m].id > 4) {
            ...
            if (((a$.urlprefix() == "ces.") || (a$.urlprefix() == "ces-demo.")) || (a$.urlprefix() == "dev.") || (a$.urlprefix() == "bgr.")) {
    ...
    function setediting(stg) {
        if (stg == "On") {
            if (((a$.urlprefix() == "ces.") || (a$.urlprefix() == "ces-demo.")) || (a$.urlprefix() == "dev.")) {
