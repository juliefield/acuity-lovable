<%@ Page Language="VB" AutoEventWireup="false" CodeFile="QualityDashboard.aspx.vb" ValidateRequest="false" Inherits="jq_QualityDashboard" %>
...
<body id="QualityDashboard" style="position:relative;" runat="server">
    ...
    <div id="reportarea" style="position: absolute; top: 96px; left: 152px; display: block; width: 100%;">
        ...
        <div class="filters" style="background-color: Gray;position:absolute;top:5px; left:10px; z-index:1; width: 390px; height: 240px;">
            ...
            <dl id="trenddl" style="display:none;">
                <dt>Trend By:</dt><dd><input type="radio" id="rdoPayperiod" name="trendtype" checked="checked" value="base" />Pay Period</dd>
                <dt></dt><dd><input type="radio" id="rdoMonth" name="trendtype" value="base" />Month</dd>
            </dl>
            <!--
