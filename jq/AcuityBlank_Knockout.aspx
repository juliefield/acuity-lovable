<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcuityBlank_Knockout.aspx.cs" ValidateRequest="false" Inherits="_AcuityBlank_Knockout" %>
...
<body>
    <div class="app-header gradient-lightest">
        ...
        <div class="app-heading">Place Application Title Here</div>
...
<script type="text/javascript" language="javascript">
    ...
    function launchApp() {
        ...
        a$.ajax({
            type: "GET", service: "JScript", async: true, data: { lib: "userprofile", cmd: "getname", username: $.cookie("username") }, dataType: "json", cache: false, error: a$.ajaxerror,
            success: loaded
        });
