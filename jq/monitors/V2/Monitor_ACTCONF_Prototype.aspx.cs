...
public partial class _Monitor_ACTCONF_Prototype : SitePage
{
    String _connection = "";
    String _connection1 = "";
    Boolean isnew = false;
                            ...
                            foreach (DataRow rowup in dtup.Rows)
                            {
                                switch (rowup["question"].ToString())
                                {
                                    ...
                                    case "Q29":
                                        ...
                                        break;
                                    case "Q30":
                                        txtQ30.Value = rowup["answer"].ToString();
                                        txtQ30text.Value = rowup["answertext"].ToString();
                                        break;
                                    case "Q31":
                                        txtQ31.Value = rowup["answer"].ToString();
                                        txtQ31text.Value = rowup["answertext"].ToString();
                                        break;
                                    case "Q32":
                                        txtQ32.Value = rowup["answer"].ToString();
                                        txtQ32text.Value = rowup["answertext"].ToString();
                                        break;
                                    case "Q1Comments":
                                    ...
                                    case "Q29Comments":
                                        ...
                                        break;
                                    case "Q30Comments":
                                        txtQ30Comments.Value = rowup["answer"].ToString();
                                        break;
                                    case "Q31Comments":
                                        txtQ31Comments.Value = rowup["answer"].ToString();
                                        break;
                                    case "Q32Comments":
                                        txtQ32Comments.Value = rowup["answer"].ToString();
                                        break;
                                    case "Comments":
            ...
            if (lblMode.Text == "new")
            {
                ...
                using (DataTable dtaux = db1.GetDataTable("select tm.team_id,tm.group_id,grp.loc_id from usr_team ut inner join team tm on tm.team_id=ut.team_id inner join grp on grp.group_id=tm.group_id where ut.user_id='" + lblAgent.Text + "'")) {
                    if (dtaux.Rows.Count > 0) {
                        ...
                        "(11/*HARDCODED*/,'" + lblAgent.Text + "','" + dtaux.Rows[0]["team_id"].ToString() + "','" + dtaux.Rows[0]["group_id"].ToString() + "','" + dtaux.Rows[0]["loc_id"].ToString() + "',2/*HARDCODED*/,'" + lblCallid.Text + "','" + lblCalldate.Text + "','" + lblCalldate.Text + "',100,0,100," + txtSuccessRate.Value.Replace("%","") + "," + txtSuccessRate.Value.Replace("%","") + ",getdate(),'" + lblSupervisor.Text + "');select scope_identity();"))
                        {
                        ...
                        if (saveme)
                        {
                                ...
                                "('" + lblAgent.Text + "','" + dtaux.Rows[0]["team_id"].ToString() + "',cast(floor(cast(getdate() as float)) as datetime),cast(floor(cast(getdate() as float)) as datetime),'" + lblSupervisor.Text + "',2/*HARDCODED*/,'" + monitorid + "');select scope_identity();"))
                            {
                                ...
                                using (DataTable dtos = db1.GetDataTable("select usr.user_id from usr inner join usr_team ut on ut.user_id=usr.user_id inner join team tm on tm.team_id=ut.team_id where tm.group_id in ('43') and usr.user_id='" + lblAgent.Text + "'"))
                                {
                                    if (dtos.Rows.Count > 0)
                                    {
                                        qmqf = "108"; //Quality (TD)
                                ...
                                if (qmqf != "108") 
                                {
                                    using (DataTable dtrole = db1.GetDataTable("select role from usr where user_id='" + lblSupervisor.Text + "' and role in ('Quality Assurance')"))
                                    {
                                        ...
                                        {
                                            qmqf = "125"; //Always Project 1 (I don't think this will ever be reached).
                                        }
                                    }
                                }
                        ...
                        //     int kpi_score = 0;
                        //     double kpi_weight = 0.0;
                        //     getscoreandweight("108",txtAssuranceTotal.Value.Replace("%", ""), ref kpi_score, ref kpi_weight);
                        //     //BLUEGREEN EXCEPTION:  Store the monitors on the REVIEW DATE (for all others it's by call date (which actually should be revisited).  WAS: '" + lblCalldate.Text.Split(' ')[0] + "' for respdt
                        //     using (DataTable dtkins = db1.GetDataTable("insert into KPI_HSTRY (user_id,team_id,respdt,entdt,entby,project_id,reference_id) values " +
                        //         "('" + lblAgent.Text + "','" + dtaux.Rows[0]["team_id"].ToString() + "',cast(floor(cast(getdate() as float)) as datetime),cast(floor(cast(getdate() as float)) as datetime),'" + lblSupervisor.Text + "',2/*HARDCODED*/,'" + monitorid + "');select scope_identity();"))
                        //     {
                        //         //TODO:
                        //         String qmqf = "108"; //Assurance (SM)
    ...
    protected void fillv2resp(String monitorid)
    {
        ...
        {
            db1.Update("delete from monitor_resp_v2prototype where monitor_id='" + monitorid + "'");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q1','" + txtQ1.Value + "','" + txtQ1text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q2','" + txtQ2.Value + "','" + txtQ2text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q3','" + txtQ3.Value + "','" + txtQ3text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q4','" + txtQ4.Value + "','" + txtQ4text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q5','" + txtQ5.Value + "','" + txtQ5text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q6','" + txtQ6.Value + "','" + txtQ6text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q7','" + txtQ7.Value + "','" + txtQ7text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q8','" + txtQ8.Value + "','" + txtQ8text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q9','" + txtQ9.Value + "','" + txtQ9text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q10','" + txtQ10.Value + "','" + txtQ10text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q11','" + txtQ11.Value + "','" + txtQ11text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q12','" + txtQ12.Value + "','" + txtQ12text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q13','" + txtQ13.Value + "','" + txtQ13text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q14','" + txtQ14.Value + "','" + txtQ14text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q15','" + txtQ15.Value + "','" + txtQ15text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q16','" + txtQ16.Value + "','" + txtQ16text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q17','" + txtQ17.Value + "','" + txtQ17text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q18','" + txtQ18.Value + "','" + txtQ18text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q19','" + txtQ19.Value + "','" + txtQ19text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q20','" + txtQ20.Value + "','" + txtQ20text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q21','" + txtQ21.Value + "','" + txtQ21text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q22','" + txtQ22.Value + "','" + txtQ22text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q23','" + txtQ23.Value + "','" + txtQ23text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q24','" + txtQ24.Value + "','" + txtQ24text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q25','" + txtQ25.Value + "','" + txtQ25text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q26','" + txtQ26.Value + "','" + txtQ26text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q27','" + txtQ27.Value + "','" + txtQ27text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q28','" + txtQ28.Value + "','" + txtQ28text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q29','" + txtQ29.Value + "','" + txtQ29text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q30','" + txtQ30.Value + "','" + txtQ30text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q31','" + txtQ31.Value + "','" + txtQ31text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',11/*HARDCODED*/,'Q32','" + txtQ32.Value + "','" + txtQ32text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',11/*HARDCODED*/,'Comments','" + db1.reap(txtComments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',11/*HARDCODED*/,'reviewtype','" + db1.reap(txtReviewType.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',11/*HARDCODED*/,'callpartytype','" + db1.reap(txtCallpartyType.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',11/*HARDCODED*/,'onlineguidance','" + db1.reap(txtOnlineGuidance.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',11/*HARDCODED*/,'Total','" + txtSuccessRate.Value.Replace("%","") + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',11/*HARDCODED*/,'AssuranceTotal','" + txtAssuranceTotal.Value.Replace("%", "") + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',11/*HARDCODED*/,'reviewname','" + db1.reap(txtReviewName.Value) + "')");
