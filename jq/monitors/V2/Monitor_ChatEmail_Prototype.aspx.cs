...
public partial class _Monitor_ChatEmail_Prototype : SitePage
{
    String _connection = "";
    String _connection1 = "";
    Boolean isnew = false;
    ...
    protected void submitme_click(object sender, EventArgs e)
    {
        ...
        using (DbBaseSql db1 = new DbBaseSql(_connection1, ""))
        {
            //DONE: Get Project,SQFCODE
            String qproject = "1";
            String qsqfcode = "6";
            using (DataTable dtp = db1.GetDataTable("select tm.project_id from usr inner join usr_team ut on ut.user_id=usr.user_id inner join team tm on tm.team_id=ut.team_id where usr.user_id='" + lblAgent.Text + "'"))
            {
                if (dtp.Rows.Count > 0)
                {
                    qproject = dtp.Rows[0][0].ToString();
                    if (qproject == "2")
                    {
                        qsqfcode = "8";
                    }
            ...
            if (lblMode.Text == "new")
            {
                ...
                using (DataTable dtaux = db1.GetDataTable("select tm.team_id,tm.group_id,grp.loc_id from usr_team ut inner join team tm on tm.team_id=ut.team_id inner join grp on grp.group_id=tm.group_id where ut.user_id='" + lblAgent.Text + "'")) {
                    if (dtaux.Rows.Count > 0) {
                        ...
                        "(" + qsqfcode + "/*HARDCODED*/,'" + lblAgent.Text + "','" + dtaux.Rows[0]["team_id"].ToString() + "','" + dtaux.Rows[0]["group_id"].ToString() + "','" + dtaux.Rows[0]["loc_id"].ToString() + "'," + qproject + "/*HARDCODED*/,'" + lblCallid.Text + "','" + lblCalldate.Text + "','" + lblCalldate.Text + "',100,0,100," + txtSuccessRate.Value.Replace("%","") + "," + txtSuccessRate.Value.Replace("%","") + ",getdate(),'" + lblSupervisor.Text + "');select scope_identity();"))
                        {
                        ...
                        if (saveme)
                        {
                            ...
                            using (DataTable dtkins = db1.GetDataTable("insert into KPI_HSTRY (user_id,team_id,respdt,entdt,entby,project_id,reference_id) values " +
                                "('" + lblAgent.Text + "','" + dtaux.Rows[0]["team_id"].ToString() + "',cast(floor(cast(getdate() as float)) as datetime),cast(floor(cast(getdate() as float)) as datetime),'" + lblSupervisor.Text + "'," + qproject + "/*HARDCODED*/,'" + monitorid + "');select scope_identity();"))
                            {
                                //DONE: Test for OS - 1
                                //DONE: Based on project, determine qmqf
                                String qmqf = "32";
                                Boolean oldrule = false;
                                if (qproject == "2")
                                {
                                    qmqf = "55";
                                }
                                else
                                {
                                    ...
                                    //Override mqf for Customer Care project, if monitor created by any of these agents.
                                    String entby = lblSupervisor.Text.ToLower();
                                    if ((entby == "sclark") || (entby == "bcoppa") || (entby == "thaas") || (entby == "ggonzale"))
                                    {
                                        qmqf = "32";
                                        oldrule = true;
                                    }
                                }
                                //2021-8-18 - MQF is "Quality (NS)" if the role of the reviewer is not in the Quality Assurance role.
                                // 2021-11-11 - Owner Services no longer wants Quality(NS) for any case.
                                //   NOTE:  Commented out 31
                                if ((!oldrule) && ( /* (qmqf == "31") || */ (qmqf == "32") || (qmqf == "55")))
                                {
                                ...
                                db1.Update("insert into KPI_RESP (kpi_id,mqf#,line#,level#,range,kpi_score,kpi_weight_factor,entdt,entby,project_id) values " +
                                    "('" + dtkins.Rows[0][0].ToString() + "'," + qmqf + "/*HARDCODED*/,1,1,'" + txtSuccessRate.Value.Replace("%","") + "','" + kpi_score.ToString() + "','" + kpi_weight.ToString() + "',cast(floor(cast(getdate() as float)) as datetime),'" + lblSupervisor.Text + "'," + qproject + "/*HARDCODED*/)");
                            }
                        }
                    }
                }
    ...
    protected void fillv2resp(String monitorid)
    {
        using (DbBaseSql db1 = new DbBaseSql(_connection1, ""))
        {
            ...
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q1','" + txtQ1.Value + "','" + txtQ1text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q2','" + txtQ2.Value + "','" + txtQ2text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q3','" + txtQ3.Value + "','" + txtQ3text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q4','" + txtQ4.Value + "','" + txtQ4text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q5','" + txtQ5.Value + "','" + txtQ5text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q6','" + txtQ6.Value + "','" + txtQ6text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q7','" + txtQ7.Value + "','" + txtQ7text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q8','" + txtQ8.Value + "','" + txtQ8text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q9','" + txtQ9.Value + "','" + txtQ9text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q10','" + txtQ10.Value + "','" + txtQ10text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q11','" + txtQ11.Value + "','" + txtQ11text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q12','" + txtQ12.Value + "','" + txtQ12text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q13','" + txtQ13.Value + "','" + txtQ13text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q14','" + txtQ14.Value + "','" + txtQ14text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q15','" + txtQ15.Value + "','" + txtQ15text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q16','" + txtQ16.Value + "','" + txtQ16text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q17','" + txtQ17.Value + "','" + txtQ17text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q18','" + txtQ18.Value + "','" + txtQ18text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q19','" + txtQ19.Value + "','" + txtQ19text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q20','" + txtQ20.Value + "','" + txtQ20text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q21','" + txtQ21.Value + "','" + txtQ21text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q22','" + txtQ22.Value + "','" + txtQ22text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q23','" + txtQ23.Value + "','" + txtQ23text.Value + "')");

            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Q24Comments','" + db1.reap(txtQ24Comments.Value) + "')");

            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Comments','" + db1.reap(txtComments.Value) + "')");

            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'reviewtype','" + db1.reap(txtReviewType.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'callpartytype','" + db1.reap(txtCallpartyType.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'onlineguidance','" + db1.reap(txtOnlineGuidance.Value) + "')");

            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'Total','" + txtSuccessRate.Value.Replace("%","") + "')");
 
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + qsqfcode + "/*HARDCODED*/,'reviewname','" + db1.reap(txtReviewName.Value) + "')");
        }
    ...
    protected void getscoreandweight(String raw,ref int kpi_score, ref double kpi_weight)
    {
        ...
        {
            //DONE: Test for OS - 2
            //DONE: Get Project, SQFCODE, determine qmqf.
            String qproject = "1";
            String qsqfcode = "6";
            using (DataTable dtp = db1.GetDataTable("select tm.project_id from usr inner join usr_team ut on ut.user_id=usr.user_id inner join team tm on tm.team_id=ut.team_id where usr.user_id='" + lblAgent.Text + "'"))
            {
            ...
            //2021-8-18 - Weight=0 (and KPI change elsewhere) if the role of the reviewer is not in the Quality Assurance role.
            if ((!oldrule) && ((qmqf == "31") || (qmqf == "32") || (qmqf == "55")))
            {
                using (DataTable dtrole = db1.GetDataTable("select role from usr where user_id='" + lblSupervisor.Text + "' and role in ('Quality Assurance')"))
                {
