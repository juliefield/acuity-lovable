<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_CentralHudson_Prototype.aspx.cs" ValidateRequest="false" Inherits="_Monitor_CentralHudson_Prototype" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Central Hudson Grid QA</title>
...
<body runat="server" style="overflow-y:scroll;">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;">Central Hudson Quality Form</div>
    </div>
        ...
        <div class="mon-content">
            ...
            <ol>
                <li>
                    ...
                    <span class="mon-answer"><select id="Q1"><option value="">--select--</option><option value="5">Yes</option><option value="0">Partial</option><option value="0">No</option><option value="3">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <p class="mon-comments"><label>Comments:</label><textarea id="Q1Comments" cols="90" rows="1"></textarea></p>
                </li>
                <li>
                    <span class="mon-question">Tone / voice inflexion</span>
                    <span class="mon-answer"><select id="Q2"><option value="">--select--</option><option value="5">Yes</option><option value="0">No</option><option value="3">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <p class="mon-comments"><label>Comments:</label><textarea id="Q2Comments" cols="90" rows="1"></textarea></p>
                </li>
                <li>
                    <span class="mon-question">Pace of agent</span>
                    <span class="mon-answer"><select id="Q3"><option value="">--select--</option><option value="5">Yes</option><option value="0">No</option><option value="3">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                ...
                <li>
                    ...
                    <span class="mon-answer"><select id="Q4"><option value="">--select--</option><option value="5">Yes</option><option value="0">No</option><option value="3">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <p class="mon-comments"><label>Comments:</label><textarea id="Q4Comments" cols="90" rows="1"></textarea></p>
                </li>
            </ol>

            <div class="mon-section">Verification</div>
            <ol start="5">
                <li>
                    <span class="mon-question">Verified accurate customer information</span>
                    <span class="mon-answer"><select id="Q5"><option value="">--select--</option><option value="5">Yes</option><option value="0">No</option><option value="2">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
            ...
            <ol start="6">
                <li>
                    <span class="mon-question">Used Hold Courtesy / Transfer Courtesy</span>
                    <span class="mon-answer"><select id="Q6"><option value="">--select--</option><option value="5">Yes</option><option value="0">No</option><option value="10">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <p class="mon-comments"><label>Comments:</label><textarea id="Q6Comments" cols="90" rows="1"></textarea></p>
                </li>
                <li>
                    <span class="mon-question">Professional Language</span>
                    <span class="mon-answer"><select id="Q7"><option value="">--select--</option><option value="5">Yes</option><option value="0">No</option><option value="4">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <p class="mon-comments"><label>Comments:</label><textarea id="Q7Comments" cols="90" rows="1"></textarea></p>
                </li>
            </ol>

            <div class="mon-section">Correct and Complete</div>
            <ol start="8">
                <li>
                    <span class="mon-question">Give correct information to the customer and follow proper next steps?<br />(payment agreement, spay, review and follow previous notes)</span>
                    <span class="mon-answer"><select id="Q8"><option value="">--select--</option><option value="10">Yes</option><option value="0">No</option><option value="3">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <p class="mon-comments"><label>Comments:</label><textarea id="Q8Comments" cols="90" rows="1"></textarea></p>
                </li>
                <li>
                    <span class="mon-question">CCHI notated with accurate and complete notes?</span>
                ...
                <li>
                    <span class="mon-question">Payment Agreement or CRC2 properly set up?</span>
                    <span class="mon-answer"><select id="Q10"><option value="">--select--</option><option value="15">Yes</option><option value="0">No</option><option value="8">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <p class="mon-comments"><label>Comments:</label><textarea id="Q10Comments" cols="90" rows="1"></textarea></p>
                </li>
                <li>
                    <span class="mon-question">Face to Face updated?</span>
                    <span class="mon-answer"><select id="Q11"><option value="">--select--</option><option value="5">Yes</option><option value="0">No</option><option value="4">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
            ...
            <ol start="12">
                <li>
                    <span class="mon-question">Confirmed questions answered / Summarize Account?</span>
                    <span class="mon-answer"><select id="Q12"><option value="">--select--</option><option value="5">Yes</option><option value="0">No</option><option value="8">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
            ...
            <ol start="13">
                <li>
                    <span class="mon-question">In/Out of Scope, Appropriate Transfer</span>
                    <span class="mon-answer"><select id="Q13"><option value="">--select--</option><option value="10">Yes</option><option value="0">No</option><option value="15">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <p class="mon-comments"><label>Comments:</label><textarea id="Q13Comments" cols="90" rows="1"></textarea></p>
                </li>
                <li>
                    <span class="mon-question">Did the customer receive FCR, would this call require a call back due to the csr?</span>
                ...
                <li>
                    <span class="mon-question">Survey offered?</span>
                    <span class="mon-answer"><select id="Q15"><option value="">--select--</option><option value="10">Yes</option><option value="0">No</option><option value="4">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
