<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_Enhancement_Quality_Form.aspx.cs" ValidateRequest="false" Inherits="_Monitor_Enhancement_Quality_Form" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Enhancement Quality Form</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Enhancement Quality Form</div>
    </div>
    ...
    <div class="mon-wrapper">
        <div class="mon-stats">
            <ul class="mon-fields">
                ...
                <li class="mon-field" ><label>COW Nominee:</label>
                    <select id="COWNominee" runat="server"><option value="">--select--</option>
                        <option value="Yes">Yes</option>
                        <option value="No">No</option>
                    </select>
                </li>
                <li class="mon-field" ><label>Salesforce Case Number:</label><span><input id="salesforceCasenum" style="width:120px;" runat="server" /></span></li><li>&nbsp;</li><li>&nbsp;</li>
                <li class="mon-field" ><label>Owner Type:</label>
                    <select id="selOwnerType" runat="server"><option value="">--select--</option>
        ...
        <div class="mon-content">
          ...
          <ol start="1">
             ...
             <li>
                 <span class="mon-question">Active Listening</span>
              ...
              <li>
                  <span class="mon-question">Offer Lodging Upgrade</span>
              ...
              <li>
                  <span class="mon-question">Offer Attraction Tickets</span>
              ...
              <li>
                  <span class="mon-question">Offer Extra Nights</span>
              ...
              <li>
                  <span class="mon-question">Proactive Callback Date & Time</span>
              ...
              <li>
                  <span class="mon-question">Followed Script</span>
              ...
              <li>
                  <span class="mon-question">Recap Vacation & Closing Statement</span>
          ...
          <ol start="10">
              ...
              <li>
                  <span class="mon-question">Collected (Y/N)</span>
            ...
            <ol style="list-style:none;padding-top: 10px;">
                <li>
                  	<form id="Form1" method="post" runat="server">
                        ...
                        <input type="hidden" id="txtSalesforceCaseNum" runat="server" value="" />
                        <input type="hidden" id="txtOwnerType" runat="server" value="" />
                        <div id="buttonwrap">
...
//                  <div class="error-anchor error-anchor-QAC1"></div>
      ...
      $(".mon-submit").bind("click", function () {
          ...
          */
		  ...
		  $("#txtCOWNominee").val($("#COWNominee").val());
          $("#txtSalesforceCaseNum").val($("#salesforceCasenum").val());
          $("#txtOwnerType").val($("#selOwnerType").val());
...
function testblanks(me) {
    ...
    blanksfound = (possible == 0) || ($("#selReviewType").val() == "") || ($("#selCallpartyType").val() == "") || ($("#selOwnerType").val() == "") /* || (asstot < 0) */;
...
$("#selOwnerType").bind("change", function () {
testblanks(this);
});
