<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_WelcomeCall_Prototype_v2.aspx.cs" ValidateRequest="false" Inherits="_Monitor_WelcomeCall_Prototype_v2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Welcome Call QA v2</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Welcome Call Quality Form v2</div>
    </div>
    ...
    <div class="mon-wrapper">
        ...
        <div class="mon-content">
          ...
          <ol start="1">
             <li>
                 <span class="mon-question">Recorded Line Statement (OB)</span>
             ...
             <li>
                 <span class="mon-question">Account Verification (IN)</span>
              ...
              <li>
                  <span class="mon-question">Welcome to the Bluegreen Family</span>
              ...
              <li>
                  <span class="mon-question">NOO Department Purpose</span>
              ...
              <li>
                  <span class="mon-question">NOO Contact Information & Hours</span>
              ...
              <li>
                  <span class="mon-question">Website Access</span>
              ...
              <li>
                  <span class="mon-question">BGO Tutorials - Learn Tab</span>
              ...
              <li>
                  <span class="mon-question">Welcome Orientation Review (Dates, Location, Room Type)
                    <br>If Not Booked: Pitched Dates / If WO Not Purchased: Pitched WO Package
                  </span>
              ...
              <li>
                  <span class="mon-question">Pitched Enhancement - Upgrade
                  </span>
              ...
              <li>
                  <span class="mon-question">Pitched Enhancement - Add Nights
                  </span>
              ...
              <li>
                  <span class="mon-question">Pitched Enhancement - Tickets
                  </span>
              ...
              <li>
                  <span class="mon-question">NASCAR/Events Mention</span>
              ...
              <li>
                  <span class="mon-question">Create Excitement - Discovery</span>
              ...
              <li>
                  <span class="mon-question">Create Excitement - Make Recommendations
                  </span>
              ...
              <li>
                  <span class="mon-question">Offer Further Assistance</span>
              ...
              <li>
                  <span class="mon-question">Call Recap</span>
          ...
          <div class="mon-section">After Call</div>
          <ol start="21">
              <li>
                  <span class="mon-question">Concierge Activator ID</span>
              ...
              <li>
                  <span class="mon-question">Case Status</span>
              ...
              <li>
                  <span class="mon-question">Salesforce Comments</span>
...
//                  <div class="error-anchor error-anchor-QAC1"></div>
      ...
      $(".mon-submit").bind("click", function () {
          ...
          /* //2024-08-06 - By Jeff, No QA section
          for (var i = 1; i <= 3; i++) {
...
for (var i = 1; i <= 3; i++) {
    ...
    if ($("#txtQA" + i + "C").val() != "") {
        ...
        setTimeout(function () {
            for (var i = 1; i <= 3; i++) {
                if ($("#txtQA" + i + "E").val() != "") {                            
                  var sp = $("#txtQA" + i + "E").val().toString().split(",");
                  for (var o in sp) {
