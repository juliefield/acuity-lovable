<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_ConfirmationCall_Prototype_v2.aspx.cs" ValidateRequest="false" Inherits="_Monitor_ConfirmationCall_Prototype_v2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Confirmation Call QA v2</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Confirmation Call Quality Form v2</div>
    </div>
        ...
        <div class="mon-content">
          ...
          <ol start="1">
             <li>
              ...
              <li>
                  <span class="mon-question">Create Excitement Pitched Add Nights</span>
              ...
              <li>
                  <span class="mon-question">Create Excitement Pitched Upgrade</span>
              ...
              <li>
                  <span class="mon-question">Create Excitement Pitched Tickets</span>
          ...
          <ol start="24">
              ...
              <li>
                  ...
                  <span class="mon-answer"><select id="Q25"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Concierge Comments</span>
                  <span class="mon-answer"><select id="Q26"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Special Request for WO reservation Submitted (if Applicable)</span>
                  <span class="mon-answer"><select id="Q27"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>                           
          </ol>
          ...
          <ol start="28">
              <li>
                  ...
                  <span class="mon-answer dv-select"><select id="Q28"><option value="">--select--</option><option value="100">Pass</option><option value="0">Fail</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>   
          </ol>
