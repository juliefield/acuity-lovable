<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_Res_Support_Quality_Form.aspx.cs" ValidateRequest="false" Inherits="_Monitor_Res_Support_Quality_Form" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Res Support Quality Form</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Res Support Quality Form</div>
    </div>
    ...
    <div class="mon-wrapper">
        ...
        <div class="mon-content">
            ...
            <ol start="1">
                ...
                <li>
                    <span class="mon-question">Conversation Silence</span>
                ...
                <li>
                    <span class="mon-question">Hold Count (1-2 max.)</span>
                ...
                <li>
                    <span class="mon-question">Hold Length (<5min)</span>
                ...
                <li>
                    <span class="mon-question">Notate Comments</span>
                ...
                <li>
                    <span class="mon-question">Checked Hotel Dates</span>
                ...
                <li>
                    <span class="mon-question">Checked Resort Dates</span>
                ...
                <li>
                    <span class="mon-question">Checked Tour Dates</span>
                ...
                <li>
                    <span class="mon-question">Pitched Alternatives</span>
                  ...
                  <div><strong>Screen Media:</strong></div>
                <li>
                    <span class="mon-question">AS400 Utilization</span>
                ...
                <li>
                    <span class="mon-question">Internet Policy Violation </span>
                    ...
                    <span>Error:
                        <select id="Q13" runat="server">
                            <option value="" selected>Select Error</option>                            
                            <option value='Shopping'>Shopping</option>
                            <option value='Social Media'>Social Media</option>
                            <option value='Unauthorized Browsing'>Unauthorized Browsing</option>
            ...
            <ol start="13">
                <li>
                    ...
                    <span class="mon-answer dv-select">
                        <select class="bvsc-answer" id="Q14">
                            <option value="">--select--</option>
  ...
  <script type="text/javascript" language="javascript">
    //  <select class="error-category" id="QAC1"><option value=""></option><option value="Agent Performance">Agent Performance</option><option value="Inventory">Inventory</option><option value="Screen Media">Screen Media</option></select>
    //  <div class="error-anchor error-anchor-QAC1"></div>
    $(".error-category").bind("change", function () {
        var opts;
        switch ($(this).val()) {
            case "Agent Performance":
                opts = ["Call Recording Statement", "Conversation Silence", "Hold Count (1-2 max.)", "Hold Length (<5min)", "Notate Comments","Took Ownership"];
                break;
            case "Inventory":
                opts = ["Checked Hotel Dates", "Checked Resort Dates", "Checked Tour Dates", "Pitched Alternatives"];
                break;
            case "Screen Media":
                opts = ["AS400 Utilization", "Internet Policy Violation"];
                break;
            default:
