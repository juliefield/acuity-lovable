<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_Club_and_OS_Quality_Feedback_Form.aspx.cs" ValidateRequest="false" Inherits="_Monitor_Club_and_OS_Quality_Feedback_Form" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Club and OS Quality Feedback Form</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Club and OS Quality Feedback Form<span style="font-weight:20px;color:Red;display:none;">&nbsp;&nbsp;DO NOT USE - THIS MONITOR IS IN DEVELOPMENT!</span></div>
    </div>
...
dates to match IDs, communicate travel documentation for trip, etc.…">Correct booking, actively preventing errors</span>
  ...
  <script type="text/javascript" src="./Monitor_Club_and_OS_Quality_Feedback_Form.aspx.js?r=5" language="javascript"></script>
  </div>
</body>
</html>
