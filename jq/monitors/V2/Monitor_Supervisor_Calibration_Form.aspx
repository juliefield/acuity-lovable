<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_Supervisor_Calibration_Form.aspx.cs" ValidateRequest="false" Inherits="_Monitor_Supervisor_Calibration_Form" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Supervisor Calibration Form</title>
...
<div class="page-wrapper2">
    <div class="page-wrapper">
        <div class="header gradient-lightest">
            ...
            <div class="heading" style="margin-left:0px;margin-top:10px;">Supervisor Calibration Form</div>
        </div>
        ...
        <div class="mon-wrapper">
            <div class="mon-stats">
                <ul class="mon-fields">
                    <li class="mon-field" ><label>Account&nbsp;#:</label><span><input id="inpAccountNum" style="width:120px;" runat="server" /></span></li>
                    ...
                    <li class="mon-field" ><label>Review&nbsp;Type</label>
                        <select id="selReviewType" runat="server">
                            <option selected="selected" value="Supervisor Calibration">Supervisor Calibration</option>
                        </select>
                    </li>
                    ...
                    <li class="mon-field" ><label>Call&nbsp;Party&nbsp;Type</label>
                        <select id="selCallpartyType" runat="server"><option value="">--select--</option>                            
                            ...
                            <option value="CXone" selected="selected">CXone</option>
            ...
            <div class="mon-content">
              <ul style="list-style:none;">
                  <li style="border-bottom: 1px solid gray;padding-top:16px;">
                      ...
                      <span class="mon-answer" style="padding-right: 290px;"><span style="display:none;">Answer</span><span class="mon-subtotal" style="width: 100px;font-weight:normal;color:Black;font-size:14px;display:none;">Points</span></span>
                  </li>
              </ul>
              <ol start="1">
                 <li>
                     <span class="mon-answer"><select id="Q1"><option value="">--select--</option><option value="1">Meets</option><option value="2">Exceeds</option><option value="0">Fails</option></select><span class="mon-subtotal" style="display:none;">&nbsp;</span></span>
                 </li>       
              </ol>

                <ol style="list-style:none;padding-top:10px;padding-right:340px;display:none;">
                ...
                <ol style="list-style:none;padding-top: 10px;">
                    <li>
                      	<form id="Form1" method="post" runat="server">
                            ...
                            <input type="hidden" id="txtQ1text" runat="server" value="" />
                            ...
                            <input type="hidden" id="txtAccountNum" runat="server" value="" />
                            <div id="buttonwrap">
    ...
    <script type="text/javascript" language="javascript">
      ...
      $(".mon-submit").bind("click", function () {
          ...
          */
          ...
          $("#txtAccountNum").val($("#inpAccountNum").val());
...
function testblanks(me) {
    ...
    blanksfound = (possible == 0) || ($("#inpAccountNum").val() == "") || ($("#selReviewType").val() == "") || ($("#selCallpartyType").val() == "") || ($("#selOnlineGuidance").val() == "") /* || (asstot < 0) */;
