...
public partial class _Monitor_Enhancement_Quality_Form : SitePage
{
    String _connection = "";
    String _connection1 = "";
    Boolean isnew = false;
                            ...
                            foreach (DataRow rowup in dtup.Rows)
                            {
                                switch (rowup["question"].ToString())
                                {
                                    ...
                                    case "callduration":
                                        ...
                                        break;
                                    case "cownominee":
                                        COWNominee.Value = rowup["answer"].ToString();
                                        break;
                                    case "salesforcecasenum":
                                        salesforceCasenum.Value = rowup["answer"].ToString();
                                        break;
                                    case "ownertype":
                                        selOwnerType.Value = rowup["answer"].ToString();
                                        break;                                                                            
                                    default:
                                        break;
                                }
            ...
            if (lblMode.Text == "new")
            {
                ...
                using (DataTable dtaux = db1.GetDataTable("select tm.team_id,tm.group_id,grp.loc_id from usr_team ut inner join team tm on tm.team_id=ut.team_id inner join grp on grp.group_id=tm.group_id where ut.user_id='" + lblAgent.Text + "'")) {
                    if (dtaux.Rows.Count > 0) {
                        ...
                        "(19/*HARDCODED*/,'" + lblAgent.Text + "','" + dtaux.Rows[0]["team_id"].ToString() + "','" + dtaux.Rows[0]["group_id"].ToString() + "','" + dtaux.Rows[0]["loc_id"].ToString() + "',2/*HARDCODED*/,'" + lblCallid.Text + "','" + lblCalldate.Text + "','" + lblCalldate.Text + "',100,0,100," + txtSuccessRate.Value.Replace("%","") + "," + txtSuccessRate.Value.Replace("%","") + ",getdate(),'" + lblSupervisor.Text + "');select scope_identity();"))
                        {
    ...
    protected void fillv2resp(String monitorid)
    {
        ...
        {
            db1.Update("delete from monitor_resp_v2prototype where monitor_id='" + monitorid + "'");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q1','" + txtQ1.Value + "','" + txtQ1text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q2','" + txtQ2.Value + "','" + txtQ2text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q3','" + txtQ3.Value + "','" + txtQ3text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q4','" + txtQ4.Value + "','" + txtQ4text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q5','" + txtQ5.Value + "','" + txtQ5text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q6','" + txtQ6.Value + "','" + txtQ6text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q7','" + txtQ7.Value + "','" + txtQ7text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q8','" + txtQ8.Value + "','" + txtQ8text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q9','" + txtQ9.Value + "','" + txtQ9text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q10','" + txtQ10.Value + "','" + txtQ10text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q11','" + txtQ11.Value + "','" + txtQ11text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "',19/*HARDCODED*/,'Q12','" + txtQ12.Value + "','" + txtQ12text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'Comments','" + db1.reap(txtComments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'reviewtype','" + db1.reap(txtReviewType.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'callpartytype','" + db1.reap(txtCallpartyType.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'Total','" + txtSuccessRate.Value.Replace("%","") + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'AssuranceTotal','" + txtAssuranceTotal.Value.Replace("%", "") + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'reviewname','" + db1.reap(txtReviewName.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'callduration','" + db1.reap(txtCallDuration.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'cownominee','" + db1.reap(txtCOWNominee.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'salesforcecasenum','" + db1.reap(txtSalesforceCaseNum.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "',19/*HARDCODED*/,'ownertype','" + db1.reap(txtOwnerType.Value) + "')");
        }
    ...
    protected void getscoreandweight(String KPI, String raw,ref int kpi_score, ref double kpi_weight)
    {
        using (DbBaseSql db1 = new DbBaseSql(_connection1, ""))
        {
            ...
            using (DataTable dt = db1.GetDataTable("select score from kpi_scoring where mqf#=" + qmqf + "/*HARDCODED*/ and " + raw + " >= range1low and " + raw + " <= range1high"))
            {
                ...
                {
                    int score;
                    if (int.TryParse(dt.Rows[0][0].ToString(), out score))
                    {
                        kpi_score = score;
                    }
                    else
