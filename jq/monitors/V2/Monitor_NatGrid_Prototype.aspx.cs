...
public partial class _Monitor_NatGrid_Prototype : SitePage
{
            ...
            if (lblMode.Text == "new")
            {
                ...
                using (DataTable dtaux = db1.GetDataTable("select tm.team_id,tm.group_id,grp.loc_id from usr_team ut inner join team tm on tm.team_id=ut.team_id inner join grp on grp.group_id=tm.group_id where ut.user_id='" + lblAgent.Text + "'")) {
                    if (dtaux.Rows.Count > 0) {
                        ...
                        "(" + lblSqfcode.Text + ",'" + lblAgent.Text + "','" + dtaux.Rows[0]["team_id"].ToString() + "','" + dtaux.Rows[0]["group_id"].ToString() + "','" + dtaux.Rows[0]["loc_id"].ToString() + "',51/*HARDCODED*/,'" + lblCallid.Text + "','" + lblCalldate.Text + "','" + lblCalldate.Text + "',100,0,100," + txtTotal.Value + "," + txtTotal.Value + ",getdate(),'" + lblSupervisor.Text + "');select scope_identity();"))
                        {
    ...
    protected void fillv2resp(String monitorid)
    {
        using (DbBaseSql db1 = new DbBaseSql(_connection1, ""))
        {
            ...
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q1','" + txtQ1.Value + "','" + txtQ1text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q2','" + txtQ2.Value + "','" + txtQ2text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q3','" + txtQ3.Value + "','" + txtQ3text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q4','" + txtQ4.Value + "','" + txtQ4text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q5','" + txtQ5.Value + "','" + txtQ5text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q6','" + txtQ6.Value + "','" + txtQ6text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q7','" + txtQ7.Value + "','" + txtQ7text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q8','" + txtQ8.Value + "','" + txtQ8text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q9','" + txtQ9.Value + "','" + txtQ9text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q10','" + txtQ10.Value + "','" + txtQ10text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q11','" + txtQ11.Value + "','" + txtQ11text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q12','" + txtQ12.Value + "','" + txtQ12text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q13','" + txtQ13.Value + "','" + txtQ13text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q14','" + txtQ14.Value + "','" + txtQ14text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q15','" + txtQ15.Value + "','" + txtQ15text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q16','" + txtQ16.Value + "','" + txtQ16text.Value + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer,answertext) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q17','" + txtQ17.Value + "','" + txtQ17text.Value + "')");

            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q1Comments','" + db1.reap(txtQ1Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q2Comments','" + db1.reap(txtQ2Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q3Comments','" + db1.reap(txtQ3Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q4Comments','" + db1.reap(txtQ4Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q5Comments','" + db1.reap(txtQ5Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q6Comments','" + db1.reap(txtQ6Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q7Comments','" + db1.reap(txtQ7Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q8Comments','" + db1.reap(txtQ8Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q9Comments','" + db1.reap(txtQ9Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q10Comments','" + db1.reap(txtQ10Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q11Comments','" + db1.reap(txtQ11Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q12Comments','" + db1.reap(txtQ12Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q13Comments','" + db1.reap(txtQ13Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q14Comments','" + db1.reap(txtQ14Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q15Comments','" + db1.reap(txtQ15Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q16Comments','" + db1.reap(txtQ16Comments.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Q17Comments','" + db1.reap(txtQ17Comments.Value) + "')");
            
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Comments','" + db1.reap(txtComments.Value) + "')");

            db1.Update("insert into monitor_imprvmnt (monitor_id,sqf_code,TXT,client_dept,ack_required,entdt,entby) values ('" + monitorid + "'," + lblSqfcode.Text + ",'','','CES',getdate(),'" + lblSupervisor.Text + "')");
            ...
            if ((txtCalllength_HH.Value != "") || (txtCalllength_MM.Value != "") || (txtCalllength_SS.Value != ""))
            {
                ...
                db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'calllength','" + db1.reap(txtCalllength_HH.Value) + ":" + db1.reap(txtCalllength_MM.Value) + ":" + db1.reap(txtCalllength_SS.Value) + "')");
            }
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'sitelocation','" + db1.reap(txtSitelocation.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'jurisdiction','" + db1.reap(txtJurisdiction.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'calltype','" + db1.reap(txtCalltype.Value) + "')");
            if (txtCalltype.Value == "Collections")
            {
                db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'category','" + db1.reap(txtCategory_collections.Value) + "')");
            }
            else
            {
                db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'category','" + db1.reap(txtCategory_move.Value) + "')");
            }
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'language','" + db1.reap(txtLanguage.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'eligible','" + db1.reap(txtEligible.Value) + "')");
            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'validtransfer','" + db1.reap(txtValidtransfer.Value) + "')");

            db1.Update("insert into monitor_resp_v2prototype (monitor_id,sqf_code,question,answer) values ('" + monitorid + "'," + lblSqfcode.Text + ",'Total','" + txtTotal.Value + "')");
        }
