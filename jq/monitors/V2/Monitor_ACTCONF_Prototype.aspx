<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_ACTCONF_Prototype.aspx.cs" ValidateRequest="false" Inherits="_Monitor_ACTCONF_Prototype" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ACT/CONF QA</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">ACT/CONF Quality Form</div>
    </div>
        ...
        <div class="mon-content">
            ...
            <ol start="1">
                <li>
                   ...
                   <span class="mon-answer"><select id="Q1"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                <li>
                    <span class="mon-question">Showed Appreciation</span>
                    <span class="mon-answer"><select id="Q2"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Showed Empathy</span>
                    <span class="mon-answer"><select id="Q3"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Understood Needs</span>
                    <span class="mon-answer"><select id="Q4"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Directed Pace and Flow</span>
                    <span class="mon-answer"><select id="Q5"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Took Ownership</span>
                    <span class="mon-answer"><select id="Q6"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Knowledgeable</span>
                    <span class="mon-answer"><select id="Q7"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Provided Guidance</span>
                    <span class="mon-answer"><select id="Q8"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Offered Alternatives</span>
                    <span class="mon-answer"><select id="Q9"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Friendly and Courteous</span>
                    <span class="mon-answer"><select id="Q10"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Re-Cap</span>
                    <span class="mon-answer"><select id="Q11"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <li>
                    <span class="mon-question">Warm Close</span>
                    <span class="mon-answer"><select id="Q12"><option value="">--select--</option><option value="Yes">Achieved</option><option value="No">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>           
            </ol>
            <div class="mon-section">Category Analysis</div>
            <ol start="13">
                <div><strong>Qualifications:</strong></div>
                <li>
                    <span class="mon-question">15-Month</span>
                ...
                <li>
                    <span class="mon-question">2 Forms ID</span>
                ...
                <li>
                    <span class="mon-question">30/90 Days</span>
                ...
                <li>
                    <span class="mon-question">CC/Debit</span>
                ...
                <li>
                    <span class="mon-question">Group Travel</span>
                ...
                <li>
                    <span class="mon-question">Income</span>
                ...
                <li>
                    <span class="mon-question">Sole/Shared Ownership</span>
                ...
                <li>
                    <span class="mon-question">Spouse Significant Other</span>
                ...
                <div><strong>Tour:</strong></div>
                <li>
                    <span class="mon-question">Choose Time</span>
                    <span class="mon-answer"><select id="Q21"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li> 
                <li>
                    <span class="mon-question">Length of Presentation</span>
                    <span class="mon-answer"><select id="Q22"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li> 
                <li>
                    <span class="mon-question">Presentation Detail</span>
                    <span class="mon-answer"><select id="Q23"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li> 
                  <div><strong>Agent Performance:</strong></div>
                <li>
                    <span class="mon-question">Call Recording Statement</span>
                    <span class="mon-answer"><select id="Q24"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <div><strong>Accomodations:</strong></div>
                <li>
                    <span class="mon-question">Cxl Policy</span>
                    <span class="mon-answer"><select id="Q25"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li> 
                <li>
                    <span class="mon-question">Enhancements</span>
                ...
                <li>
                    <span class="mon-question">Unit Error</span>
                    <span class="mon-answer"><select id="Q27"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                </li>
                <div><strong>Other:</strong></div>
                <li>
                    <span class="mon-question">Category:</span>
                    <span class="mon-answer"><select id="Q28"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
                    <span>
                        <select id="Q29" runat="server">
                    ...
                    <span>Error:
                        <select id="Q30" runat="server">
                            <option value="" selected>Select Error</option>
                            <option value='Age 25'>Age 25</option>
                            <option value='Checklist Error'>Checklist</option>
            ...
            <ol style="list-style:none;padding-top: 10px;">
                <li style="height:25px;">
                    <span class="mon-question" style="font-weight: bold;font-size:20px;">Monitor Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <span class="mon-answer" style="font-weight: bold;font-size:20px;">                        
                        <span class="mon-subtotal mon-total" id="montotal">0</span>
                ...
                <li style="height:25px;">
                    <span class="mon-question" style="font-weight: bold;font-size:20px;">Success Rate&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <span class="mon-answer" style="font-weight: bold;font-size:20px;">                        
            ...
            <ol start="29">
                <li>
                    ...
                    <span class="mon-answer dv-select">
                        <select class="bvsc-answer" id="Q31">
                            <option value="">--select--</option>
                            <option value="100">Yes</option>
                            <option value="0">No</option>
                        </select>
                        <span class="bvsc-total">&nbsp;</span>
                    </span>
                </li>  
                <li>
            ...
            <ul style="list-style:none;">
                <li>
                    <p class="mon-comments"><textarea id="Comments"></textarea></p>
                </li>
            </ul>
            <ol style="list-style:none;padding-top: 10px;">
                <li style="height:25px;">
  ...
  <script type="text/javascript" language="javascript">
    ...
    function testblanks(me) {
            ...
            if (!$(this).hasClass("mon-answer-special")) {
                ...
                if (val != "") {
                    if (!isNaN(val)) {
                        ...
                        else if ($(this).attr("id") != "Q31") {
                            tot += parseInt(val, 10);
                            possible += 1;
                        }
                    }
                    if ($(".bvsc-answer").val() != 100) {
                        $(".bvsc-total").css("color", "red");
                    } else {
                        $(".bvsc-total").css("color", "blue");
                    }
                }
                else {
                    //blanksfound = true;
        ...
        if (asstot < 0) {
            $(".assurance-total").html('<span><br>QA Pass/Fail not specified - you may submit with no QA data.</span>').css("color", "red");
        }
        else if (asstot > 0) {
            $(".assurance-total").css("color", "blue").html(asstot + '%');
            $(".ass-total").css("color", "blue");
        }
        else if (asstot == 0) {
            $(".assurance-total").css("color", "red").html(asstot + '%');
            $(".ass-total").css("color", "red");
        }
        ...
        if (sr <= 84) {
            $(".mon-subtotal").css("color", "red");
        } else if (sr >= 85) {
            $(".mon-subtotal").css("color", "blue");
        }
    }
    /*
