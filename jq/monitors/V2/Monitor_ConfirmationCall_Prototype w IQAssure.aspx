<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_ConfirmationCall_Prototype w IQAssure.aspx.cs" ValidateRequest="false" Inherits="_Monitor_ConfirmationCall_Prototype_w_IQAssure" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Confirmation Call QA w IQAssure</title>
...
.chat-play-audio:hover, .chat-stop-audio:hover {
...
.chat-journalsave:hover {
  background-color: #016c97 !important;
}
.content-one {
  display:none;
}
...
.wave {
  width: 5px;
  height: 20px;
  background: linear-gradient(45deg, #016c97, #fff);
  margin: 10px;
...
.chat-generate:hover, .copy-table:hover {
  background: #016c97 !important;
}   
.chat-table {
...
.message.ai:first-of-type .message {
  font-size: 16px;
  font-weight: bold;
}
.show-chat.ai:first-of-type .show-chat {
  font-size: 16px;
  font-weight: bold;
}
...
<body runat="server" style="overflow-y:scroll;background-color: #0074c2;">
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Confirmation Call QA w IQAssure</div>
    </div>
    ...
    <div class="mon-wrapper">
        <div class="mon-stats">
            <ul class="mon-fields">
                ...
                <li class="mon-field" ><label>Call Duration:</label><span><input id="inpCallDuration" style="width:120px;" runat="server" /></span></li>
                <li class="mon-field" ><label>COW Nominee:</label>
                    <select id="selCOWNominee" runat="server"><option value="">--select--</option>
                        <option value="Yes">Yes</option>
                        <option value="No">No</option>
                    </select>
                </li>
                <button type="button" class="copy-table" id="copyTable"><i class="fa-duotone fa-sparkles" aria-hidden="true"></i> Table Data</button>
            </ul>
      ...
      <!----------------------->
      <button type="button" class="chat-generate" style="display:none;margin-right:45%;"><i class="fa-duotone fa-sparkles" aria-hidden="true"></i> Get Guidance</button>
      <div class="chat-container" style="margin-bottom:10px;display:none;">
        <textarea style="height:auto;width:98%;overflow:vertical;resize:both;display:none;" class="chat-prompt-header">The following table contains a contact center agent's graded quality assurance scorecard. The table contains each question and answer, Overall Score (out of a possible 100), Numerator/Denomintor (used to calculate Overall Score), Call Rank, and input from the agent's Supervisor.
        Review each line item in the following table, omitting line items with no point value (N/A). Point values of 1 were Achieved and point values of 0 were answered Needs Coaching. Create detailed and specific coaching guidance for the supervisor preparing to coach the agent on their performance on this scorecard.
          1. How did the agent perform overall on this scorecard? 
          2. Positive Reinforcement: Highlighting the areas where the agent excelled, acknowledging their strengths and good practices.
          3. Areas for Improvement: Identifying the areas where the agent did not meet the standard or could improve.
          4. Action Plan: Providing specific, actionable suggestions for how the agent can improve in the identified areas.
          5. Follow-up: Suggesting a follow-up plan to review the agent's progress and reinforce the coaching.  
        </textarea>
        <textarea style="height:auto;width:98%;overflow:vertical;resize:both;display:none;" class="chat-data" runat="server">Grid...</textarea>                          
        <div class="center chat-response" style="flex-wrap: wrap;display:none;">
          <h3 style="display:block;width:100%;text-align:center;">Generating Coaching Guidance and Plan...</h3>
          <div class="wave"></div>
          <div class="wave"></div>
          <div class="wave"></div>
          <div class="wave"></div>
        ...
        <div class="chat-table" style="display:none;">
          <div class="message ai">
            <span class="show-chat"></span>              
          </div>
        </div>
        <div align="center"> 
          <input class="chat-play-audio" type="button" value="Play Audio" style="display:none;width:100px;cursor:pointer;">
          <input class="chat-stop-audio" type="button" value="Stop Audio" style="display:none;margin-left:20px;width:100px;cursor:pointer;">
          <br><br>
          <input class="chat-journalsave" type="button" value="Save to Sidekick" style="display:none;">
        </div> 
      </div>
      <input type="text" class="hidden-chat-response qst" qst="ChatResponse" style="display:none;" value="">
      <br /><br /><br /><br /><br /><br />
      <!----------------------->                      
    </div>
    <div style="height:50px;"></div>
        ...
        <div class="mon-content">
          <div class="mon-section">Call Flow</div>
          <ol start="1">
             <li>
                 <span class="mon-question">Recorded Line Statement (Outbound)</span>
              ...
              <li>
                  <span class="mon-question">Verify account info (Inbound)</span>
              ...
              <li>
                  <span class="mon-question">Accomodations - Confirm dates</span>
              ...
              <li>
                  <span class="mon-question">Accomodations - Advised hotel name & Room Type</span>
              ...
              <li>
                  <span class="mon-question">Accomodations - Review amenities</span>
              ...
              <li>
                  <span class="mon-question">Accomodations - Confirm & update guest list</span>
              ...
              <li>
                  <span class="mon-question">Verified Credit/Debit card</span>
              ...
              <li>
                  <span class="mon-question">Reviewed Taxes, Parking, Resort fees or any additional applicable fees</span>
              ...
              <li>
                  <span class="mon-question">Reviewed Check-in procedures</span>
              ...
              <li>
                  <span class="mon-question">Set expectation of Welcome Orientation time and date</span>
              ...
              <li>
                  <span class="mon-question">Covered Spousal/deed holders</span>
              ...
              <li>
                  <span class="mon-question">Verified monthly payments</span>
              ...
              <li>
                  <span class="mon-question">Valid govt. ID, St issued Driver's License, or passport</span>
                  <span class="mon-answer"><select id="Q13"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Cancelation Policy & fees</span>
                  <span class="mon-answer"><select id="Q14"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Create Excitement (Pitched Enhancements)</span>
                  <span class="mon-answer"><select id="Q15"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Create Excitement - Sizzle</span>
                  <span class="mon-answer"><select id="Q16"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Offered Further Assitance</span>
                  <span class="mon-answer"><select id="Q17"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Friendly</span>
                  <span class="mon-answer"><select id="Q18"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Courteous</span>
                  <span class="mon-answer"><select id="Q19"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Call Pace</span>
                  <span class="mon-answer"><select id="Q20"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Product Knowledge</span>
                  <span class="mon-answer"><select id="Q26"><option value="">--select--</option><option value="1">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
          </ol>
          <div class="mon-section">Pre & Post Call</div>
          <ol start="22">
              <li>
                  <span class="mon-question">Is the owner eligible to travel
                    <br>(TSW Contract status, AS400 - Confirmed owner has not toured in the last 30 days)
                  </span>
                  <span class="mon-answer"><select id="Q21"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Concierge clicked the confirmation travel box</span>
                  <span class="mon-answer"><select id="Q22"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Concierge Comments</span>
                  <span class="mon-answer"><select id="Q23"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Special Request for WO reservation Submitted (if Applicable)</span>
                  <span class="mon-answer"><select id="Q24"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>                           
          </ol>
          <ol style="list-style:none;padding-top: 10px;padding-right:340px;">
          ...
          <div class="mon-section">Pass/Fail</div>
          <ol start="26">
              <li>
                  <span class="mon-question">Pass/Fail</span>
                  <span class="mon-answer dv-select"><select id="Q25"><option value="">--select--</option><option value="100">Pass</option><option value="0">Fail</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>   
          </ol>
            ...
            <ol style="list-style:none;padding-top: 10px;">
                <li style="height:25px;">
                    <span class="mon-question" style="font-weight: bold;font-size:20px;margin-left:600px;">Assurance Total&nbsp;&nbsp;&nbsp;<span class="assurance-total" id="assurancetotal">0</span>
                </li>
            </ol> 
            ...
            <ol style="list-style:none;padding-top: 10px;">
                <li>
                  	<form id="Form1" method="post" runat="server">
                        ...
                        <input type="hidden" id="txtCallDuration" runat="server" value="" />
                        <input type="hidden" id="txtCOWNominee" runat="server" value="" />
  ...
  <script src="https://kit.fontawesome.com/550f4bc1b1.js?Bump=2317" crossorigin="anonymous"></script>
...
//                  <div class="error-anchor error-anchor-QAC1"></div>
      ...
      $(".error-category").bind("change", function () {
          ...
          switch ($(this).val()) {
              case "Qualifications":
                  ...
                  break;
              case "Accomodations":
                  opts = ["Arrival date not booked", "Length of Stay", "Based on Availability", "Incidentals", "Incorrect Tax", "Cxl Policy", "Unit Error", "Enhancements", "No Show Policy", "Seasonal Fees"];
                  break;
              case "Incentives":
              ...
              case "Agent Performance":
                  opts = ["Disposition","Request to CXL/Refund","Call Recording Statement","False Claims","Another Account","Incorrect Offer", "Pitch vs. Offer", "Checklist Error", "Missing Genie", "Welcome Center", "Cold Transfer", "Dead Air", "Discovery Questions", "Exceeded Hold Time", "Further Assistance", "Gratitude", "Intro. - Name or Company", "OB Permissive Response", "Recap - Dates/Dest" ];
                  break;
      ...
      $(".mon-submit").bind("click", function () {
		  ...
		  $("#txtCallDuration").val($("#inpCallDuration").val());
		  $("#txtCOWNominee").val($("#selCOWNominee").val());
      });
...
$(document).ready(function () {
    $(".copy-table, .fa-duotone, .fa-sparkles").click(function() {
          $("body").scrollTop(0);
          var txttocopy = "";
          $('.mon-content').find("*").each(function() {
            if ($(this).is(":visible")) {
              if ($(this).children().is("select")) {
                var selecttxt = $(this).find("option:selected").val();
              } else {
                selecttxt = ($(this).text().replace(/,/g, ""));
              }
              if (selecttxt.trim() !== "") {
                txttocopy += selecttxt + ", ";
              }
          ...
          $(".chat-data").text(txttocopy);
          $(".chat-generate").show();
        }); 
      
        $(".chat-generate, .fa-duotone, .fa-sparkles").on("click", function() {      
          $(".chat-response").show("slow");
          $.post(
            "https://aitest.acuityapmr.com/request",
            {
              prefix: a$.urlprefix().split(".")[0],
              descPrompt: $(".chat-prompt-header").val(),
              gridPrompt: $(".chat-data").val(),
              gridSignature: $(".tbl-identkey").html(),
              aiService: {
            ...
            function(data, status) {
              ...
              $(".chat-play-audio").show();
              $(".chat-stop-audio").show();
            }
          );
          $(".chat-container").show();
          $(".chat-generate").hide();
          $(".chat-journalsave").show().bind("click", function() {
            alert("debug: Saving Journal Form");
            var bld = $(".message-body:last").html();
            a$.ajax({
              type: "POST",
              service: "JScript",
              async: false,
              data: {
                ...
                record: { 
                  id: "", //"" Means "new record"
                  // User: $("#selCSRs", a$.WindowTop().document).val(),
                  User: $("#lblAgent").html(),
                  Date: "09/12/2023", //Recdate (required, HC for now).
                  Reason: "General",
                  DeliveredBy: "AI System",
                  DetailsIssues: bld
                }
              },
              dataType: "json",
              cache: false,
              error: a$.ajaxerror,
              success: sidekicksaved
            });
            function sidekicksaved(json) {
              if (json.saved) {
                  alert("Sidekick save complete");
              }
              else {
                  alert("Sidekick save failed");
              }
            }
    	    return false;
          });
        ...
        function generateAudio(text) {
          ...
          // Find/Replace Onyx voice actual name
          var voiceRequested = voices.find(function(voice) {
            return voice.name === voice;
          });
        
          // Check if requested voice is found
          if (voiceRequested) {
            utterance.voice = voiceRequested;
            alert("Notice to end user: The text-to-speech voice is AI-generated and not a human voice.");
          
          } else {
            alert("Notice to end user: The text-to-speech voice is AI-generated and not a human voice. Using default voice.");
            console.warn("Requested voice not found. Using default voice.");
            utterance.voice = voices[0]; // Using first available voice as a fallback
          }
        
          // Listen for the end of the speech synthesis
          ...
          // Play audio
          $(".chat-play-audio").on("click", function() {
        ...
        $(".chat-stop-audio").on("click", function() {
          stopAudio();
        });
        ...
        function showResponse(responseText) {    
          var $messageContainer = $("<div>").addClass("message ai");
          var $messageBody = $("<span>").addClass("message-body").html(responseText.replace(/\n/g, "<br>"));      
          $messageContainer.append($messageBody);
          $(".chat-table").append($messageContainer);
          $(".chat-table").show();
          var chattext=$('.chat-table').html();
          $('.hidden-chat-response').val(chattext);
          $(".chat-response").hide("slow");
        } 
        ...
        function textToSpeech(text, voice) {
          $.post(
            ...
            function (data, status) {
              ...
              if (status === "success") {
                // Play audio
                var audio = new Audio(responseText);
                audio.play();
              } else {
