<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_WelcomeCall_Prototype.aspx.cs" ValidateRequest="false" Inherits="_Monitor_WelcomeCall_Prototype" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Welcome Call QA</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Welcome Call Quality Form</div>
    </div>
        ...
        <div class="mon-content">
          ...
          <ol start="18">
              ...
              <li>
                  ...
                  <span class="mon-answer"><select id="Q17"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Case Status</span>
                  <span class="mon-answer"><select id="Q18"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>
              <li>
                  <span class="mon-question">Salesforce Comments</span>
                  <span class="mon-answer"><select id="Q19"><option value="">--select--</option><option value="1">Yes</option><option value="0">No</option><option value="N/A">N/A</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>                           
          </ol>
          ...
          <ol start="22">
              <li>
                  ...
                  <span class="mon-answer dv-select"><select id="Q20"><option value="">--select--</option><option value="100">Pass</option><option value="0">Fail</option></select><span class="mon-subtotal">&nbsp;</span></span>
              </li>   
          </ol>
