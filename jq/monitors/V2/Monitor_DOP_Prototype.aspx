<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_DOP_Prototype.aspx.cs" ValidateRequest="false" Inherits="_Monitor_DOP_Prototype" %>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">DOP Quality Form</div>
    </div>
    ...
    <div class="mon-wrapper">
        ...
        <div class="mon-content">
            ...
            <ol start="1">
                ...
                <li>
                    <span class="mon-question">Age 25</span>
                ...
                <li>
                    <span class="mon-question">FICO</span>
                ...
                <li>
                    <span class="mon-question">Incidentals</span>
                ...
                <li>
                    <span class="mon-question">Taxes/Fees</span>
                ...
                <li>
                    ...
                    <span>
                        <select id="Q21" runat="server">
                            <option value="" selected>Select Category</option>
                            <option value='Agent Performance'>Agent Performance</option>
                        </select><br>
                    </span>
                    <span>Error:
                        <select id="Q22" runat="server">
                            <option value="" selected>Select Error</option>                            
                            <option value='Checklist Error'>Checklist Error</option>
                            <option value='Incorrect Offer'>Incorrect Offer</option>
                            <option value='Request to Cxl/Refund'>Request to Cxl/Refund</option>
                            <option value='Using Anothers CC'>Using Anothers CC</option>                            
                        </select>
                    </span>
                </li>
            ...
            <ol start="21">
                <li>
                    ...
                    <span class="mon-answer dv-select">
                        <select class="bvsc-answer" id="Q23">
                            <option value="">--select--</option>
                ...
                <li>
                    ...
                    <span class="">
                        <select style="display:none;"><option value="">--select--</option><option value="">Achieved</option><option value="0">Needs Coaching</option><option value="N/A">N/A</option></select><span class="">&nbsp;</span></span>
                    <span>
                        <select id="Q24" runat="server">
                            <option value="" selected>Select Disposition</option>
                            <option value='BK Booked'>BK - Booked</option>
                            <option value='BK21 Booked Within 21 Days'>BK21 - Booked Within 21 Days</option>
                            <option value='CONF Confirmed'>CONF - Confirmed</option>
                            <option value='IBB Inbound Booked'>IBB - Inbound Booked</option>
                            <option value='Manual OB Booked'>Manual OB - Booked</option>  
                            <option value='VS Verified Sale'>VS - Verified Sale</option>
                        </select>
                    </span>
                </li>                                 
            </ol>
