$(document).ready(function () {
    ...
    */
    ...
    function client_action_init() {
        ...
        client_setscore();
        $(".qst-QAAuditCategory").unbind().bind("change", function () {
            if ($(this).val() == "235") { //Other
                $(".qst-qaaudit-other-show").show();
            }
            else {
                $(".qst-QAAuditOther").val("");
                $(".qst-qaaudit-other-show").hide();
            }
        });
        ...
        $(".qst-QAAuditCategory").trigger("change");
    ...
    function init_control(kickout) {
        ...
        //else if ($("#lblRole").html() == "CorpAdmin") { //Surrogate Manager
            ...
            || ($("#lblViewer").html().toLowerCase() == "u12842")
            ) {
            ...
            $(".compliance-agree").unbind().bind("click", function () {
                if ($(".qst-timestamp-complianceagree").val() == "") {
                    $(".qst-timestamp-complianceagree").val((d.toLocaleDateString() + " " + d.toLocaleTimeString()).replace(/\?/g, ""));
                }            
            });
            $("#acknowledgeme").hide();
            $(".mgr-agree").attr("disabled", "disabled");
