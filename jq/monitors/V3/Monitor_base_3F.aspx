<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_base_3F.aspx.cs" ValidateRequest="false" Inherits="_Monitor_base_3F" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="<%# ResolveUrl("~/applib/css/DONOTLOAD-monitor-custom-styling.css?r=6") %>" />
    ...
    <style id="CDS_CSSFLOWContent" media="all" runat="server" type="text/css">
    </style>
...
<div class="cds-editors" style="display:none;">
    <div class="cds-css-editor" style="display:none;">
        <h5>CSS <span class="ac-cds-hideshow"></span>  <span class="ac-cds-left">&lt;</span> <span class="ac-cds-date" cid="CDS_CSSEditor"></span> <span class="ac-cds-right" >&gt;</span></h5>
    ...
    <div class="cds-cssflow-editor" style="display:none;">
        <h5>CSS&nbsp;FLOW<span class="ac-cds-hideshow"></span></h5>
        <div class="ac-cds" id="CDS_CSSFLOWEditor"></div>
    </div>
    <div class="cds-htmlflow-editor" style="display:none;">
        <h5>HTML&nbsp;FLOW <span class="ac-cds-hideshow"></span></h5>
        <div  class="ac-cds" id="CDS_HTMLFLOWEditor"></div>
    </div>
    <div class="cds-jsflow-editor" style="display:none;">
        <h5>Javascript&nbsp;FLOW <span class="ac-cds-hideshow"></span></h5>
        <div  class="ac-cds" id="CDS_JSFLOWEditor"></div>
    </div>
    <input type="button" class="cds-save-flow" value="Save HTML/JS FLOW" />
</div>
  ...
  <div class="ui-view ac-view" style="display:none;">
    ...
    <!-- Header -->
      ...
      <div contenteditable="false" class="cds-html-flow-content" id="CDS_HTMLFLOWContent" runat="server">
      </div>
      ...
      <div style="display:none;">
        ...
        <asp:Label style="display:none;" id="lblAgentTest" runat="server"></asp:Label>
        <asp:Label style="display:none;" id="lblAgentLockout" runat="server"></asp:Label>
...
<script type="text/javascript">
  (function () {
    ...
    <div ID="CDS_JSFLOWContent" runat="server">
        <script type="text/javascript">
        </script>
    </div>

    <script type="text/javascript" src="./Monitor_base_3F.js?r=5t4" language="javascript"></script>
  </body>
</html>
