    ...
    function init_control() {
        ...
        $(".ac-setup-form").unbind().bind("click", function () {
            ...
            var data = {
                ...
                mans: mans,
                database: "C",
                clean: false,  //IF true, then remove existing questions/sections before starting (will create new qst and sec ids, which may not be good if reports depend on them).
            };
            a$.ajax({
                type: "POST",
                service: "JScript",
