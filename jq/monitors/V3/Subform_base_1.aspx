<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subform_base_1.aspx.cs" ValidateRequest="false" Inherits="_Subform_base_1" %>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./Subform_base_1.js?r=67" language="javascript"></script>
  </body>
</html>
