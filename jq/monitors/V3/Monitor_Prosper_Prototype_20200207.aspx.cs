...
public partial class _Monitor_Prosper_Prototype_20200207 : SitePage
{
    String _connection = "";
    String _connection1 = "";
    Boolean isnew = false;
    ...
    {
        Page.Theme = "Monitors";
        _connection1 = CONFMGR.ConnectionStrings(/*urlprefix()*/"ces." + "Connection").ConnectionString; // +";Provider=SQLOLEDB;";
        _connection = CONFMGR.ConnectionStrings(/*urlprefix()*/"ces." + "Connection20").ConnectionString; // +";Provider=SQLOLEDB;";
    }
