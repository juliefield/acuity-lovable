$(document).ready(function () {
    ...
    //Logan, FYI - a$.gup("lettertype") would contain GHP or NGHP
    //..so the tests could have been if (passed_lettertype == "GHP"), etc.
    //Your way works fine though, just fyi a$.gup("myparam") is used heavily.
    ...
    //Too early to set these vals, the combo-manager box is overwritten below
    /*
    ...
    */
    ...
    $(".mon-submit,.mon-rebuttal,.mon-rebuttalresponse,.mon-coaching").bind("click", function () {
