<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_base_KM2.aspx.cs" ValidateRequest="false" Inherits="_Monitor_base_KM2" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head id="Head1" runat="server">
    ...
    <style id="CDS_CSSContent" runat="server" type="text/css">
  ...
  <body runat="server" class="ui-review-body">
    <form id="Form1" method="post" runat="server">
      <div class="ui-review-title">
        <div class="ui-title-container">
          <button onclick="printFunction()">Print this page</button>
          <a class="ac-close" href="">&#8592; Back</a> <span>|</span> <label class="display-lblSqfname top-label"></label>
        </div>
      </div>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./Monitor_base_KM2.js?r=6" language="javascript"></script>
  </body>
</html>
