<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subform_base_1_child.aspx.cs" ValidateRequest="false" Inherits="_Subform_base_1_child" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" ng-app="angularApp">
  <head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="<%# ResolveUrl("~/applib/dev/FORMS1/FORMS1-view/forms.css?r=6") %>" media="screen" />
    <link rel="stylesheet" href="<%# ResolveUrl("~/applib/css/journal-list.css?r=6") %>" media="screen" />
...
<div class="ui-view ac-view" style="display:none;">
    ...
    <br /><textarea class="qst qst-comment" qst="TestCommentBox">Text Comment Box</textarea>
      ...
      <div style="display:none;">
        ...
        <asp:Label ID="lblParentMasterId" runat="server"></asp:Label>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./Subform_base_1_child.js?r=67E" language="javascript"></script>
  </body>
</html>
