<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_Prosper_Prototype_20200207.aspx.cs" ValidateRequest="false" Inherits="_Monitor_Prosper_Prototype_20200207" %>
    ...
    <table class="mon-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="background-color:Orange;" colspan="2">Incomplete, Inaccurate or Inappropriate Documentation</td>
                <td style="background-color:Orange;text-align: center;" >1</td>
                <td style="text-align: center;">
            ...
            <tr>
                ...
                <td></td>
                <td>Annotated Complaint Properly</td>
            ...
            <tr>
                ...
                <td></td>
                <td>Did the Agent Document the Interaction?</td>
                <td style="text-align: center;">-15%</td>
                <td style="text-align: center;">
                    <select class="qst qst-hp-7_3" qst="7.3">
                        <option value="No" class="sel-red">No</option>
                        <option value="N/A"  class="sel-yellow">N/A</option>
                    </select>
                </td>
                <td></td>
                <!-- <td style="background-color:SkyBlue;"><input class="qst" qst="C-7.3" type="text" /></td> -->
            </tr>
            <tr>
                <td style="background-color:LightPink;">High Penalty</td>
                <td style="text-align: center;">7.4</td>
                <td></td>
                <td>Call Recording Disclosure Not Given (3rd Party)</td>
                <td style="text-align: center;">-5%</td>
                <td style="text-align: center;">
                    <select class="qst qst-hp-7_4" qst="7.4">
                        <option value="No" class="sel-red">No</option>
                        <option value="N/A"  class="sel-yellow">N/A</option>
                    </select>
                </td>
                <td></td>
                <!-- <td style="background-color:SkyBlue;"><input class="qst" qst="C-7.4" type="text" /></td> -->
            </tr>
            <tr>
                <td style="background-color:LightPink;">High Penalty</td>
                <td style="text-align: center;">7.5</td>
                <td></td>
                <td>Postponing Interation (Wait Date)</td>
                <td style="text-align: center;">-5%</td>
                <td style="text-align: center;">
                    <select class="qst qst-hp-7_5" qst="7.5">
                        <option value="No" class="sel-red">No</option>
                        <option value="N/A"  class="sel-yellow">N/A</option>
                    </select>
                </td>
                <td></td>
                <!-- <td style="background-color:SkyBlue;"><input class="qst" qst="C-7.5" type="text" /></td> -->
            </tr>
            <tr>
                <td style="background-color:LightPink;">High Penalty</td>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    <select class="qst qst-effectiveness" qst="8.1">
                        ...
                        <option value="Passing" class="sel-green">Passing</option>
                        <option value="Ineffective" class="sel-green">Ineffective</option>
                        <option value="Non-Compliant"  class="sel-red">Non-Compliant</option>
                    </select>
                    <!--
                        <option value="Not Scored" class="sel-green">Not Scored</option>
                        <option value="No Call"  class="sel-red">No Call</option>
                    -->
                </td>
                <td></td>
            ...
            <tr>
                ...
                <td style="border: 1px solid gray;vertical-align: middle;padding: 10px;min-height: 50px;" colspan="5">
                    <textarea class="qst qst-comments" qst="Comments" style="height:80px !important; resize: vertical;"></textarea>
                </td>
                <td></td>
                <td style="text-align: center;">
      ...
      $(document).ready(function () {
          ...
          $(".mon-table select").bind("change", function () {
              ...
              if (allsetup) {
                  ...
                  cascadeup("7", ["7.1", "7.2", "7.3", "7.4", "7.5"]);
              }
              setscore();
          });
          ...
          function setscore() {
              ...
              if ($(".qst-hp-7_3").val() == "No") {
                  score -= 15.0;
              }
              if ($(".qst-hp-7_4").val() == "No") {
                  score -= 5.0;
              }
              if ($(".qst-hp-7_5").val() == "No") {
                  score -= 5.0;
              }
