<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_Coaching_Correspondence_Process_Lockbox.aspx.cs" ValidateRequest="false" Inherits="_Monitor_Coaching_Correspondence_Process_Lockbox" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
  <head id="Head1" runat="server">
    <title>Internal Review / CPLB</title>
    ...
    <form id="Form1" method="post" runat="server">
      <div class="monitor-review-title">
        <div class="monitor-title-container">
          ...
          <a class="mon-close" href="">&#8592; Back</a> <span>|</span> Performant - Internal Review / CPLB
        </div>
      </div>
      <div class="monitor-view">
        ...
        <div ng-show="monitoringnow()">
          ...
          <table class="monitor-table" style="display:none;">
            ...
            <tbody class="tbl-not-cplb" style="display:none;">
              <tr>
              ...
              <tr>
                ...
                <td class="show-coaching" style="display:none;">
                    <table style="width:100%">
                        ...
                        <tr>
                            <td>
                                <textarea class="qst qst-coaching-comments" qst="coaching-desc-CorrIndex"  id="coaching5" name="coaching5" onkeyup="resizeTextarea('coaching5')" data-resizable="true" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                            </td>
                            <td style="width:30%">
                                <input type="checkbox" class="coaching-completed-checkbox" id="completed5"/>
                                <input disabled="disabled"class="qst qst-coaching-timestamp" id="P4" qst="coaching-timestamp-CorrIndex"/>
                            </td>
                        </tr>
                    </table>
                </td>
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="comments-CorrIndex" id="comment5" name="comment5" onkeyup="resizeTextarea('comment5')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td class="show-coaching" style="display:none;">
                    <table style="width:100%">
                        ...
                        <tr>
                            <td>
                                <textarea class="qst qst-coaching-comments" qst="coaching-desc-IncWorkType"  id="coaching4" name="coaching4" onkeyup="resizeTextarea('coaching4')" data-resizable="true" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                            </td>
                            <td style="width:30%">
                                <input type="checkbox" class="coaching-completed-checkbox" id="completed4"/>
                                <input disabled="disabled"class="qst qst-coaching-timestamp" id="P3" qst="coaching-timestamp-IncWorkType"/>
                            </td>
                        </tr>
                    </table>
                </td>
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="comments-IncWorkType" id="comment4" name="comment4" onkeyup="resizeTextarea('comment4')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td class="show-coaching" style="display:none;">
                    <table style="width:100%">
                        ...
                        <tr>
                            <td>
                                <textarea class="qst qst-coaching-comments" qst="coaching-desc-IncCaseID"  id="coaching4" name="coaching4" onkeyup="resizeTextarea('coaching4')" data-resizable="true" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                            </td>
                            <td style="width:30%">
                                <input type="checkbox" class="coaching-completed-checkbox" id="completed4"/>
                                <input disabled="disabled"class="qst qst-coaching-timestamp" id="P3" qst="coaching-timestamp-IncCaseID"/>
                            </td>
                        </tr>
                    </table>
                </td>
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="comments-IncCaseID" id="comment4" name="comment4" onkeyup="resizeTextarea('comment4')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>                                                    
            </tbody>
            <tfoot>
              <tr>
                ...
                <td style="font-size:16px;text-align: center;background-color:White;font-weight: bold;display:none;" class="show-score mon-sys-score"></td>
                ...
                <td style="font-size:16px;text-align: center;background-color:White;font-weight: bold;display:none;" class="show-disp mon-sys-autofail"></td>
                ...
                <td colspan="2" rowspan="2" style="text-align: center;vertical-align:middle;">
                              ...
                              <tr>
                                  <td>
                                      <div qst="AuditedSelectRowCount" class="mon-show-reviewnotes" style="text-align: center;">
                                          ...
                                          <textarea class="qst qst-comments mon-field-reviewnotes" qst="ReviewNotes" type="text" style="margin:10px;width: 80%; height:30px; border: none;" ng-disabled="readonly()" ng-modelHOLD="f.Comment" placeholder="Review Notes"></textarea>
                  ...
                  <div class="mon-show-qanotes" style="display:none;text-align: center;">
                    ...
                    <textarea class="qst qst-comments mon-field-qanotes" qst="QANotes" type="text" style="display:none;margin:10px;width:80%;height:30px;border:none;" ng-disabled="readonly()"  ng-modelHOLD="f.Comment" placeholder="QA Notes"></textarea>
                    ...
                    <textarea class="qst qst-comments mon-field-reasonnotes" qst="ReasonNotes" disabled="disabled" type="text" style="margin:10px;width:80%;height:30px;border:none;" placeholder="Hold/Release Notes"></textarea>
                    <br /><br />
                    <div>
              ...
              <tr class="mon-rebuttal-block-b" style="display:none;" disabled>
                ...
                <td colspan="2">
                  <textarea class="qst qst-comments mon-field-rebuttal-b" qst="Rebuttal-b" type="text" id="comment15" name="comment15" onkeyup="resizeTextarea('comment15')" data-resizable="true" ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
              ...
              <tr class="mon-rebuttalresponse-block-b" style="display:none;">
                ...
                <td colspan="2" style="background: white;">
                  <textarea class="qst qst-comments mon-field-rebuttalresponse-b" qst="RebuttalResponse-b" id="comment16" name="comment16" onkeyup="resizeTextarea('comment16')" data-resizable="true" type="text" ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                ...
                <td>
                  <div style="float:left;margin-left:5px;">
                    <input type="checkbox" class="mon-sys-rebuttalresponsesuccess-b qst" qst="RebuttalResponseSuccess-b" /> Rebuttal resulted in a change in scoring.<br /><br />
              ...
              <tr class="mon-rebuttal-block-c" style="display:none;">
                ...
                <td colspan="2">
                  <textarea class="qst qst-comments mon-field-rebuttal-c" qst="Rebuttal-c" type="text" id="comment17" name="comment17" onkeyup="resizeTextarea('comment17')" data-resizable="true" ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                  <div class="mon-sys-rebuttalshow" style="display:none;">Rebuttal - level 3 Entered By:
                    <input class="qst mon-sys-rebuttalshow mon-sys-rebuttal-stash-c" qst="RebuttalMgr-c" style="display:none;" ng-model="f.lettertypeselection" />
                  </div>
                </td>
                <td>
                  <div style="float:left;margin-left:5px;">
              ...
              <tr class="mon-rebuttalresponse-block-c" style="display:none;">
                ...
                <td colspan="2" style="background: white;">
                  <textarea class="qst qst-comments mon-field-rebuttalresponse-c" qst="RebuttalResponse-c" id="comment18" name="comment18" onkeyup="resizeTextarea('comment18')" data-resizable="true" type="text" ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                ...
                <td>
                  <div style="float:left;margin-left:5px;">
                    <input type="checkbox" class="mon-sys-rebuttalresponsesuccess-c qst" qst="RebuttalResponseSuccess-c" /> Rebuttal resulted in a change in scoring.<br /><br />
              ...
              <tr>
                <td><p>Show Coaching: <input type="checkbox" id="coachingCheckBox"/></p></td>
              </tr>
          ...
          <div style="display:none;">
            ...
            <input type="text" class="qst" qst="RebuttalTS-b" />
            <input type="text" class="qst" qst="RebuttalResponseTS-b" />
          </div>
          <div style="display:none;">
            ...
            <input type="text" class="qst" qst="RebuttalTS-c" />
            <input type="text" class="qst" qst="RebuttalResponseTS-c" />
          </div>
          
        </div>
      </div>
    </form>
    <script type="text/javascript" src="./Monitor_Coaching_Correspondence_Process_Lockbox.js?r=36t" language="javascript"></script>
    <script>
