<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonitorLink_base_1.aspx.cs" ValidateRequest="false" Inherits="_MonitorLink_base_1" %>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./MonitorLink_base_1.js?r=9" language="javascript"></script>
  </body>
</html>
