...
public partial class _Monitor_base_KM2 : SitePage
{
    String _connection = "";
    String _connection1 = "";
    String _client = "0";
            ...
            using (DbBaseSql db1 = new DbBaseSql(_connection1, "")) {
                using (DbBaseSql db = new DbBaseSql(_connection, ""))
                {
                    ...
                    */
                    ...
                    //KM2
                    using (DataTable dtkm2 = db1.GetDataTable("select CC,DEPT,JOB_CLS from usr_client where user_id='" + lblAgent.Text + "'"))
                    {
                        lblAgentCenter.Text = "";
                        lblAgentClient.Text = "";
                        lblAgentLOB.Text = "";
