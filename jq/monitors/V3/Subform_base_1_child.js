...
$(document).ready(function () {
    ...
    var parentmasterid = $("#lblParentMasterId").html();

    if ((parentmasterid == "") || (parentmasterid == "0") || (parentmasterid == "null")) {
        alert("Parent ID Not Found, contect TPO technical services");
        return false;
    }
    else {
    ...
    function processSubmit() {
        ...
        //alert("debug: Affirming that parent forms don't save from a child view");
        return_to_v1();
        return false;
