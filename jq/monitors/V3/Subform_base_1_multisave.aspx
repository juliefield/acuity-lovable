<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subform_base_1_multisave.aspx.cs" ValidateRequest="false" Inherits="_Subform_base_1_multisave" %>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./Subform_base_1_multisave.js?r=15" language="javascript"></script>
  </body>
</html>
