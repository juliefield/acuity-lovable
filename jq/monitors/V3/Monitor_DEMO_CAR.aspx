<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_DEMO_CAR.aspx.cs" ValidateRequest="false" Inherits="_Monitor_DEMO_CAR" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    ...
    <link rel="stylesheet" href="<%# ResolveUrl("~/applib/css/evaluation-form.css") %>" media="screen" />
    ...
    <form id="Form1" method="post" runat="server">
      <div class="monitor-review-title" style="position:relative;">
        <div class="monitor-title-container">
          ...
          <div class="monitor-top-close">
            <a class="mon-close" href="">&#8592; Back</a> <span>|</span> <label id="show_lblSqfname" class="top-monitor-label"></label>
          </div>
          <div class="monitor-state">State</div>
        </div>
      </div>
<div id="MonitorHTMLEditor"></div>
<div class="qst-draft">DRAFT MODE <em>(This Monitor is in Draft, <strong>not</strong> visible to DM/TM/CSRs)</em></div>
        ...
        <div ng-show="monitoringnow()">
          <table style="width:100%;">
            <tr>
              ...
              <td style="border: thin solid #afafaf;border-right:none;border-bottom:none;padding-left: 15px;padding-top: 10px;background: #ddd;">Previous Points:</td>
              <td style="border: thin solid #afafaf;border-left:none;border-bottom:none;padding-top: 10px;background: #ddd;">
                <span>
            ...
            <tr>
              ...
              <td style="border-left: thin solid #afafaf;padding-left: 15px;background: #ddd;">Form Point Total:</td>
              <td style="border-right: thin solid #afafaf;background: #ddd;">
                <span>
            ...
            <tr>
              ...
              <td style="border: thin solid #afafaf;border-top:none;border-right:none;padding-left: 15px;padding-bottom:15px;background: #ddd;">Rolling 90 Day Point Total:</td>
              <td style="border: thin solid #afafaf;border-left:none;border-top:none;padding-bottom:15px;background: #ddd;">
                <span>
            ...
            <tr>
              <td style="padding-bottom: 20px;">Hire Date: </td>
              <td class="mon-sys-HireDate" style="padding-bottom: 20px;">
                <label id="show_lblAgentHireDate"></label>
              </td>
              <td style="padding-left: 40px;width: 170px;"></td>
              <td class="mon-sys-LocationName">
                
              </td>
           </tr>
            <tr class="table-margin">
              <td style="border-top: thin solid #afafaf;padding-top: 15px;">Auditor: </td>
              <td style="border-top: thin solid #afafaf;margin-right: 30px;padding-top: 15px;">
                <span>
                  <label id="show_lblSupervisorName"></label>
                </span>
              </td>
               <td style="padding-left: 40px;border-top: thin solid #afafaf;margin-right: 30px;padding-top: 15px;">
                Office: <label id="show_lblAgentLocationName"></label>
               
               </td>
              <td style="border-top: thin solid #afafaf;margin-right: 30px;padding-top: 15px;">
                DM: 
                <select class="combo-groupleader qst" qst="GroupLeader" ng-model="f.GroupLeader" ng-disabled="readonly()" style="" >
                  <option value=""></option>
                </select>
              </td>
            </tr>
            <tr class="table-margin">
              ...
              <td style="padding-left: 40px;">
                CAR #: <label id="show_lblMonitorId"></label>
              </td>
              <td>
                TM:
                <select class="combo-teamleader qst" qst="TeamLeader" ng-model="f.GroupLeader" ng-disabled="readonly()" style="width: 226px;" >
                  <option value=""></option>
                </select>
              </td>
            </tr>
            <tr class="table-margin">
              ...
              <td class="audit-types">
                <div><input type="checkbox" value="Y" class="qst" qst="AuditType_Phone" /> Phone</div>
                <div><input type="checkbox" value="Y" class="qst" qst="AuditType_Lawsuit" /> Legal</div>
                <div><input type="checkbox" value="Y" class="qst" qst="AuditType_Complaint" /> Complaint</div>
                <div><input type="checkbox" value="Y" class="qst" qst="AuditType_Demand" /> Demand</div>
                <div><input type="checkbox" value="Y" class="qst " qst="AuditType_InternalFinding" /> Internal Finding</div>
                <div><input type="checkbox" value="Y" class="qst qst-qaaudit" qst="AuditType_QAAudit" /> QA Audit</div>
              </td>
              <td style="padding-left: 40px;">
                Escalate:
              </td>
              <td>
                ...
                &nbsp&nbsp;<input type="text" class="qst esc-date" qst="EscalationDate" style="width: 217px;" />
              </td>
            </tr>
            <tr>
              <td><span class="qst-qaauditshow">Audit Category</span></td>
              <td><span class="qst-qaauditshow"><select class="qst" qst="QAAuditCategory" style="max-width: 460px;"></select></span></td>
...
-->
          ...
          <div style="margin: 0 auto 0 auto">
            <div class="form-box-group" style="display:none;">
              ...
              <div class="form-box-item">
                <label style="float:left;"><strong>Client:</strong></label>
    ...
    <script type="text/javascript" src="./Monitor_DEMO_CAR.js?r=19" language="javascript"></script>
  </body>
</html>
