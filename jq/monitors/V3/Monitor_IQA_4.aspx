<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_IQA_4.aspx.cs" ValidateRequest="false" Inherits="_Monitor_IQA_4" %>
...
.ui-section-header>dd select {
  ...
  <body runat="server">
    <form id="Form1" method="post" runat="server">
      <div class="page-wrapper2">
          ...
          <table class="mon-table">
            <thead>
              ...
              <tr class="mon-table-header">
                ...
                <th colspan="3" class="mon-sys-Calldate">
                  <asp:Label ID="lblCalldate2" runat="server"></asp:Label>
                </th>
                <th></th>
                <th></th>
              </tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td></td>
                <td>Did agent request the Balance In Full (BIF) and/or Past Due amount and/or advise Consumer of current status (Disconnection date, charge off date, etc.)? If declined, did agent offer payment arrangements or value payment if applicable?</td>
                <td ></td>
                <td >
              ...
              <tr>
                ...
                <td></td>
                <td>Did agent reasonably attempt to follow the negotiation hierarchy?(Assumptive attempt for BIF, past due amount) and did the agent establish a timeline for a payment arrangement including date and method of payment?</td>
                <td ></td>
                <td >
              ...
              <tr>
                ...
                <td></td>
                <td>Did the agent avoid false or misleading information?</td>
                <td ></td>
                <td >
              ...
              <tr>
                ...
                <td></td>
                <td>Did the agent adhere to all applicable state & Federal laws, and regulations?</td>
                <td ></td>
                <td >
              ...
              <tr>
                ...
                <td></td>
                <td>Did the agent adhere to all client specific requirements?</td>
                <td ></td>
                <td >
              ...
              <tr>
                ...
                <td></td>
                <td>Did the agent note the account in W8, including at minimum: who they spoke to and where, how consumer verified, if disclosures were provided, if payments arrangements were agreed to, if/why consumer was upset/disputing/complaining, etc.)? And did the agent note the account in the client portal if applicable?</td>
                <td ></td>
                <td >
              ...
              <tr>
                ...
                <td></td>
                <td>Did the agent exceed expectations for a great consumer experience (I.E., could this call be used in training or presented to the client as an example of exceptional consumer service & negotiating skills while still being compliant)?</td>
                <td ></td>
                <td >
              ...
              <tr class="last-row">
                <td style="vertical-align: middle;min-height: 50px;" colspan="4">
                  <div style="margin-bottom:8px;">Strengths and Areas of Improvement:</div>
		...
		<dl class="ui-section-header">
			<dt>Entity</dt>
			<dd>
				<select class="qst" qst="Entity">
				  <option value="ACT">ACT</option>
				  <option value="Alltran">Alltran</option>
				  <option selected="selected" value="COI">COI</option>
			...
			<dt>Monitor ID:</dt>
			<dd><asp:Label ID="lblMonitorId" runat="server"></asp:Label></dd>
			<dt>Employee Name/ID:</dt>
			<dd>
			...
			<dt>Location:</dt>
			<dd><asp:Label id="lblAgentLocationName" runat="server"></asp:Label></dd>
			<dt>Call ID:</dt>
			<dd class="display-lblCallid">
                 <asp:Label ID="lblCallid" runat="server"></asp:Label>
            </dd>
			<dt>Date/Time of Call:</dt>
			<dd><asp:Label ID="lblCalldate" runat="server"></asp:Label></dd>
			<dt>Auditor:</dt>
			<dd><asp:Label id="lblSupervisorName" runat="server"></asp:Label></dd>
			<dt>Duration&nbsp;(sec):</dt>
			<dd><input class="qst dv-number" qst="CallDuration" type="text" value="0"></dd>
			<dt>Call Direction:</dt>
			<dd><select id="callDirection" class="qst" qst="CallDirection"><option selected="selected" value="Inbound">Inbound</option><option value="Outbound">Outbound</option></select></dd>
			<dt>Call Type:</dt>
			<dd><select id="Select1" class="qst" qst="calltype">
		  <option selected="selected" id="RPC">RPC</option>
	  <option id="NRPC">NRPC</option>
		  </select></dd>
			<dt>Survey Tracking:</dt>
			<dd><input class="qst" type="text" qst="SurveyTracking" value=""></dd>
			<dt>Call #:</dt>
			<dd><input class="qst" type="text" qst="CallNum" value=""></dd>
			<dt>Call Monitoring Type:</dt>
			<dd><select id="callMonType" class="qst" qst="CallMonType">
				<option selected="selected" id="New Hire">New Hire</option>
				<option id="Regular">Regular</option>
				</select></dd>
			<dt>State</dt>
			<dd>
				<select class="qst qst-state" qst="State" style="width:150px;">
					<option value="">Select One</option>
            ...
            <dd><input type="text" class="qst qst-spectrum-number" qst="Account ID" /></dd>
			<dt>Directory</dt>
			<dd>
                <input class="qst" type="text" qst="Directory" value="">
			</dd>        
			<dt>Call Recording Session ID:</dt>
			<dd><input class="qst" type="text" qst="CallRecSesID" value=""></dd>
			<dt>Client Name</dt>
			<dd>
			  <select class="qst combo-clientdept" qst="Client"></select>
			</dd>
			<!--<dt>Client</dt>
			<dd>
				<select class="qst" qst="Client">
							  <option value="BROMENN">BROMENN</option>                  
							  <option value="BSA">BSA</option>
							  <option value="CharterCare">CharterCare</option> 
							  <option value="Elements">Elements</option>
							  <option value="EPMG">EPMG</option>
							  <option value="Fortis">Fortis</option>
							  <option value="KCI">KCI</option>                  
							  <option value="MARIN">MARIN</option>
							  <option value="Mercy One">Mercy One</option>                  
							  <option value="NAPLES">NAPLES</option>
							  <option value="NYU">NYU</option>                  
							  <option value="OSF">OSF</option>
							  <option value="Schoolcraft">Schoolcraft</option>                  
							  <option value="SILVERCROSS">SILVERCROSS</option>                  
			...
			<dt>Client ID:</dt>
			<dd><input class="qst" type="text" qst="ClientID" value=""></dd>
			<dt>Quality Score:</dt>
			<dd><span class="mon-sys-score ac-scoreqout" style="font-weight: bold;">0</span></dd>
			<dt></dt>
			<dd><span class="ac-autofail" style="display:none;">AUTO FAIL</span></dd>
			<!--<dt>Reason Call was Monitored</dt>
			<dd>
				<select class="qst" qst="ReasonToGrade">
							  <option value="">Select One</option>
							  <option value="Random Call Monitoring">Random Call Monitoring</option>
							  <option value="Random Call Monitoring - *Live*">Random Call Monitoring - *Live*</option>
							  <option value="Client Deliverables">Client Deliverables</option>
    ...
    <script type="text/javascript" src="./Monitor_IQA_4.js?r=14" language="javascript"></script>
  </body>
</html>
