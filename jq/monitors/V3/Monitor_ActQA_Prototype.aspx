<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_ActQA_Prototype.aspx.cs" ValidateRequest="false" Inherits="_Monitor_ActQA_Prototype" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body runat="server">
          ...
          <table class="mon-table">
            <thead>
              <tr class="mon-table-header">
                <th rowspan="5" colspan="4" style="width: 55%;">
                  ...
                  <div class="heading">ACT QA Scorecard</div>
                </th>
              ...
              <tr class="mon-table-header">
                <th>Client/Dept</th>
                <th colspan="3" >
                  <select  class="qst combo-clientdept" qst="Client" style="width:120px;margin-top:5px;">
                  </select>
                </th>
                <th></th>
                <th></th>
            ...
            <tbody>
              <tr>
                ...
                <td style="background-color:#0091D0;color:#fff;width:39%" colspan="2" >Compliance- No issues: 35, Up to 1 issue: 15, More than 1 issue: 0</td>
                <td class="centered" style="background-color:#0091D0;color:#fff;width:10%;" >35</td>
                <td style="width:10%;">
                  <input type="text" style="text-align:center;" class="qst qst-Compliance-Score" qst="Compliance-Score" />
                </td>
              ...
              <tr>
                ...
                <td style="background-color:#965BA5;color:#fff;width:39%" colspan="2" >Policy- No issues: 25, Up to 3 issues: 10, More than 3 issues: 0</td>
                <td class="centered" style="background-color:#965BA5;color:#fff;width:10%;" >25</td>
                <td style="width:10%;">
                  <input type="text" style="text-align:center;" class="qst qst-Policy-Score" qst="Policy-Score" />
                </td>
                <!-- <td style="background-color:#18bba2;width:24%"><input class="qst" qst="C-1" type="text" /></td> -->
              </tr>
              <tr>
                ...
                <td style="background-color:#18bba2;width:39%" colspan="2" >Negotiation- No issues: 20, Up to 2 issues: 10, More than 2 issues: 0</td>
                <td class="centered" style="background-color:#18bba2;width:10%;" >20</td>
                <td style="width:10%;">
                  <input type="text" style="text-align:center;" class="qst qst-Negotiation-Score"  qst="Negotiation-Score" />
                </td>
                <!-- <td style="background-color:#18bba2;width:24%"><input class="qst" qst="C-1" type="text" /></td> -->
              </tr>
              <tr>
                ...
                <td style="background-color:#e04984;color:#fff;width:39%" colspan="2" >Customer Experience- No issues: 20, Up to 2 issues: 5, More than 2 issues: 0</td>
                <td class="centered" style="background-color:#e04984;color:#fff;width:10%;" >20</td>
                <td style="width:10%;">
                  <input type="text" style="text-align:center;" class="qst qst-CustEx-Score"  qst="CustEx-Score" />
                </td>
                <!-- <td style="background-color:#18bba2;width:24%"><input class="qst" qst="C-1" type="text" /></td> -->
              </tr>
              <tr>
                <td class="mon-category" colspan="6">Greeting & Verification</td>
              </tr>
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >330-1</td>
                <td></td>
                <td>(P) Did the agent properly verify the consumer's identity (last four of SSN, DOB, Home Address, or the school attended.) according to the client requirements? Did Agent confirm the first and last name of the Consumer?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="330-1">
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >330-2</td>
                <td></td>
                <td>(P) The collector identified themselves and the company as Account Control Technology?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="330-2">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >330-3</td>
                <td></td>
                <td>(P) Did the Collector give CQM (Recording) Statement? Turn off recording when asked to?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="330-3">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                ...
                <td class="centered" >330-4</td>
                <td></td>
                <td>(C) The collector gave the Mini Miranda and notify Consumer they are a Debt Collector, prior to disclosing specific debt information?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="330-4">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >331-1</td>
                <td></td>
                <td>(P) Did the Collector identify client correctly?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="331-1">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >331-2</td>
                <td></td>
                <td>(P) File Maintenance Question: Did the Agent ask what is the best number to call Consumer? Did the Agent obtain a valid email address, mailing address (if return address or no address is on file) & update if provided?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="331-2">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >331-3</td>
                <td></td>
                <td>(C) Third Party Communications: Did the Collector avoid disclosing any confidential information to 3rd party?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="331-3">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
              ...
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >331-4</td>
                <td></td>
                <td>(C) The collector only asked for Location Information when talking to a 3rd party? (Home address, home phone number, or name of POE)</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="331-4">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td class="mon-category" colspan="6">Negotiation Skills</td>
              </tr>
              <tr>
                <td style="background-color:#18bba2;">Negotiation</td>
                <td class="centered" >332-1</td>
                <td></td>
                <td>(N) Did the Collector request or state the Balance in full when applicable?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="332-1">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >332-2</td>
                <td></td>
                <td>(P) Total Permanent Disability: Upon becoming aware the borrower may qualify for total permanent disability, did the collector refer the borrower to Nelnet?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="332-2">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#18bba2;">Negotiation</td>
                <td class="centered" >332-3</td>
                <td></td>
                <td>(N) Payment Arrangements: Did the collector enter the correct information into the calculator? (AGI & family size)</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="332-3">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#18bba2;">Negotiation</td>
                <td class="centered" >332-4</td>
                <td></td>
                <td>(N) Did the Collector follow the negotiation hierarchy, payment timeline, offer all applicable financial options: PIF, SIF Parameters, 15% Rehab, FIS, Consolidation, and or standard re-payment? GA- explore alternative sources of funds when applicable</td>
                <td ></td>
                <td>
                  <select  class="qst" qst="332-4">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#18bba2;">Negotiation</td>
                <td class="centered" >333-1</td>
                <td></td>
                <td>(N) Did the collector obtain a full and complete financial profile/statement when applicable?</td>
                <td ></td>
                <td>
                  <select  class="qst" qst="333-1">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >333-2</td>
                <td></td>
                <td>(C) Did the collector misstate or mislead any of the payment dates, amounts, and or arrangements?</td>
                <td ></td>
                <td>
                  <select  class="qst" qst="333-2">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >333-3</td>
                <td></td>
                <td>(P) Did the Collector educate Consumer /Follow Script - Update Financial Statement, Properly educate the borrower on benefits, Title IV, and garnishment process per script?</td>
                <td ></td>
                <td>
                  <select  class="qst" qst="333-3">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                ...
                <td class="centered" >333-4</td>
                <td></td>
                <td>(CE) Did the collector explain the urgency of returning the Rehabilitation letter and Proof of Income (POI)?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="333-4">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td class="mon-category" colspan="6">Regulatory Compliance</td>
              </tr>
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >334-1</td>
                <td></td>
                <td>(C) Did the collector threaten garnishment (AWG), litigation or tax offsets?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="334-1">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >334-2</td>
                <td></td>
                <td>(C) Did the collector add the phone number to the DNC list when the borrower told them they did not want calls to a specified number? Did the agent follow DNC protocol to avoid consumer complaint(s)?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="334-2">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >334-3</td>
                <td></td>
                <td>(C) Did the collector overshadow borrower's rights in the 30-day validation period?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="334-3">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >334-4</td>
                <td></td>
                <td>(C) Did the Collector ask if the number is a cell phone and if we have permission to dial the number via an automated dialing system regarding the account? (TCPA) Ask permission to send SMS text messages, leave recorded messages if applicable?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="334-4">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >335-1</td>
                <td></td>
                <td>(C) Did the collector make any other FDCPA, UDAAP, State Law violations, False & Misleading Statements, Avoid HIPAA violations?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="335-1">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td style="background-color:#0091D0;color:#fff;">Compliance</td>
                <td class="centered" >335-2</td>
                <td></td>
                <td>(C) Did the collector obtain authorization from the account holder when setting up an electronic debit or other forms auto payment? Did the Collector follow the Reg-E disclosure when applicable?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="335-2">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >335-3</td>
                <td></td>
                <td>(P) Did the collector violate protocol by telling the borrower they were a Financial Advisor, Financial Specialist, or any tax related professional?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="335-3">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >335-4</td>
                <td></td>
                <td>(P) Did the agent adhere to all Client call quality specific requirements?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="335-4">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td class="mon-category" colspan="6">Professionalism</td>
              </tr>
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >336-1</td>
                <td></td>
                <td>(P) Did the collector properly resolve any disputes with the borrower?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="336-1">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#e04984;color:#fff;">Customer Experience</td>
                <td class="centered" >336-2</td>
                <td></td>
                <td>(CE) Did the agent control the call and communicate confidently, actively listen and appropriately respond to consumer questions/concerns/objections?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="336-2">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#e04984;color:#fff;">Customer Experience</td>
                <td class="centered" >336-3</td>
                <td></td>
                <td>(CE) Did the collector document the account correctly, all necessary action codes/panels and properly tweak payments in alignment with their department requirements if applicable? Summarize the call, future communications?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="336-3">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                <td style="background-color:#965BA5;color:#fff;">Policy</td>
                <td class="centered" >336-4</td>
                <td></td>
                <td>(P) Did the agent avoid raising their voice in a way that would be considered confrontational, argumentative, or harassing by the consumer (i.e did the consumer make a comment indicating that they thought the agent was being rude or unprofessional?)</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="336-4">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="No (High Risk)" class="sel-red">No (High Risk)</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
              ...
              <tr>
                <td style="background-color:#e04984;color:#fff;">Customer Experience</td>
                <td class="centered" >336-5</td>
                <td></td>
                <td>(CE) Did the Collector exceed expectations for a Great consumer Experience (i.e could this call be used in training as an example of exceptional consumer service and negotiating skills while still being compliant & adhere to all ACT Policies, etc.)?</td>
                <td ></td>
                <td >
                  <select  class="qst" qst="336-5">
                    <option value="Yes" class="sel-green">Yes</option>
                    <option value="No" class="sel-red">No</option>
                    <option value="N/A"  class="sel-yellow">N/A</option>
                  </select>
              ...
              <tr>
                ...
                <td></td>
                <td>High Risk Pending Warning Level</td>
                <td ></td>
                <td >
              ...
              <tr>
                ...
                <td >
                  <select  class="qst qst-reasontograde" qst="ReasonToGrade" style="width:200px;">
                    ...
                    <option value="Compliance Finding">Compliance Finding</option>
                    <option value="Complaint Received – No Recording">Complaint Received – No Recording</option>
              ...
              <tr>
                ...
                <td >
                  <select  class="qst qst-calltype" qst="CallType" style="width:200px;">
                    <option value="">Select One</option>
                    <option value="1st Communication">1st Communication</option>
              ...
              <tr>
                ...
                <td >
                  <select  class="qst qst-objection" qst="Objection" style="width:200px;">
                    <option value="">Select One</option>
                    <option value="Attorney Representation on Account">Attorney Representation on Account</option>
                    <option value="Bankruptcy">Bankruptcy</option>
                    <option value="Cease & Disease">Cease &amp; Disease</option>
                    <option value="Closed Account">Closed Account</option>
                    <option value="Disaster Relief Hold">Disaster Relief Hold</option>
                    <option value="Dispute">Dispute</option>
                    <option value="Promise to Pay">Promise to Pay</option>
                    <option value="Refusal to Pay">Refusal to Pay</option>
                    <option value="Roll Back">Roll Back</option>
                    <option value="SCRA">SCRA</option>
                    <option value="State Mandated Hold">State Mandated Hold</option>
                    <option value="Other">Other</option>
              ...
              <ul class="mon-fields">
                ...
                <li class="mon-field" >
                  ...
                  <span>
                    ...
                    <asp:Label style="display:none;" id="lblClientDept" runat="server"></asp:Label>
                  </span>
                </li>
                <li class="mon-field" >
    ...
    <script type="text/javascript" src="./Monitor_ActQA_Prototype.js?r=5" language="javascript"></script>
  </body>
</html>
