<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_Toyota_v3.aspx.cs" ValidateRequest="false" Inherits="_Monitor_Toyota_v3" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head id="Head1" runat="server">
    <title>ACT Toyota V3 Scorecard</title>
  ...
  <body runat="server">
          ...
          <table class="mon-table">
            <thead>
              <tr class="mon-table-header">
                <th rowspan="5" colspan="4" style="width: 55%;">
                  ...
                  <div class="heading">ACT Toyota Scorecard V3</div>
                </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colspan="3">
                    <select  class="qst editable" qst="2b-flags" multiple="multiple" size="12">
                        ...
                        <option value="2b-11">2b-11: TFS/LFS Account Number entered into Speedpay incorrectly.</option>
              ...
              <tr>
                ...
                <td colspan="3">
                    <select  class="qst editable" qst="3a-flags" multiple="multiple" size="11">
                        ...
                        <option value="3b-5">3a-5: Identify yourself </option>
                        <option value="3a-6">3a-6: Misinterpreting Privacy guidelines and being too conservative regarding the release of information</option>
                        <option value="3a-7">3a-7: Outbound Call: Do not request the primary or co-x to provide any part of the SSN (Exception: Speedpay)</option>
                        <option value="3a-8">3a-8: State Toyota/Lexus Financial after outbound authentication is complete and on all inbound calls</option>
                        <option value="3a-9">3a-9: Stated full company name prior to authentication on outbound calls</option>
                        <option value="3a-10">3a-10: Third Party: Obtain first and last name (and the company they represent, if applicable)</option>
                        <option value="3a-11">3a-11: Other</option>
                    </select>
                    <a class="mon-clear-select" title="Clear Selections">X</a>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="3">
                    <select  class="qst editable" qst="3b-flags" multiple="multiple" size="25">
                        ...
                        <option value="3b-3">3b-3: Call Monitoring Disclosure: Business rules not followed</option>
                        <option value="3b-4">3b-4: CCS: Outbound Call: Do not request the primary or co-x to provide any part of their SSN (Exception: Speedpay, if needed)</option>
                        <option value="3b-5">3b-5: Collateral: Verification incomplete or no attempt made</option>
                        <option value="3b-6">3b-6: Customer account details should not be updated when speaking with a NSS or Third Party.</option>
                        <option value="3b-7">3b-7: Disclosing account specific information with an unauthorized NSS or unauthorized Third Party.</option>
                        <option value="3b-8">3b-8: Faxing or mailing documentation to an alternate location other than the Customer's system fax number/address without the Customer's specific authorization</option>
                        <option value="3b-9">3b-9: Improper Authentication (Customer / Co Borrower / NSS / Authorized Third Party)</option>
                        <option value="3b-10">3b-10: INS: Agreement, application number or full VIN not obtained/verified</option>
                        <option value="3b-11">3b-11: LY- SL sent and Consent statement not delivered</option>
                        <option value="3b-12">3b-12: LY- SL sent by gaining consent from NSS</option>
                        <option value="3b-13">3b-13: LY- SL sent to originating dealer instead of mover dealership</option>
                        <option value="3b-14">3b-14: LY- SL sent without customer's affirmative response to consent</option>
                        <option value="3b-15">3b-15: NSS Relationship not obtained/verified</option>
                        <option value="3b-16">3b-16: PII: Provided to unauthorized NSS or unauthorized Third Party</option>
                        <option value="3b-17">3b-17: PII: Provided to other contract signer </option>
                        <option value="3b-18">3b-18: Providing account number without verifying additional information</option>
                        <option value="3b-19">3b-19: Providing the full Vehicle Identification Number (VIN) to the Customer</option>
                        <option value="3b-20">3b-20: Reciting the Account Holder's name to a Third Party or Non Signing Spouse (NSS)</option>
                        <option value="3b-21">3b-21: Reciting the Account Holder's name to the Customer prior to authentication</option>
                        <option value="3b-22">3b-22: Reciting the street name, number, apt. number, PO Box or more than the last two digits of the telephone number to the Customer, Co-Borrower, or Non Signing Spouse (NSS); unless provided by the Customer</option>
                        <option value="3b-23">3b-23: Reciting the website usernames, email addresses, and/or passwords</option>
                        <option value="3b-24">3b-24: Other</option>
                    </select>
                    <a class="mon-clear-select" title="Clear Selections">X</a>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="3">
                    <select  class="qst editable" qst="5c-flags" multiple="multiple" size="11">
              ...
              <tr>
                ...
                <td colspan="3">
                    <select  class="qst editable" qst="6a-flags" multiple="multiple" size="8">
                        ...
                        <option value="6a-5">6a-5: Payment Method: Inaccurate information provided</option>
                        <option value="6a-6">6a-6: Review all applicable systems/sources and provide accurate information</option>
                        <option value="6a-7">6a-7: Talking points were stated inaccurately when they were not required</option>
                        <option value="6a-8">6a-8: Other</option>
                    </select>
                    <a class="mon-clear-select" title="Clear Selections">X</a>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="3">
                    <select  class="qst editable" qst="6b-flags" multiple="multiple" size="7">
                        ...
                        <option value="6b-3">6b-3: Speedpay: Correctly update/enter information in the Speedpay system</option>
                        <option value="6b-4">6b-4: Speedpay: One or more talking points were missed or stated incorrectly</option>
                        <option value="6b-5">6b-5: Speedpay: One or more verification steps not completed or completed incorrectly</option>
                        <option value="6b-6">6b-6: WUQC: One or more talking points were missed or stated incorrectly</option>
    ...
    <script type="text/javascript" src="./Monitor_Toyota_v3.js?r=10" language="javascript"></script>
  </body>
</html>
