<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subform_base_2.aspx.cs" ValidateRequest="false" Inherits="_Subform_base_2" %>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./Subform_base_2.js?r=2" language="javascript"></script>
  </body>
</html>
