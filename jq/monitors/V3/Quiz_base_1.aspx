<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Quiz_base_1.aspx.cs" ValidateRequest="false" Inherits="_Quiz_base_1" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" ng-app="angularApp">
  <head id="Head1" runat="server">
    ...
    <script type="text/javascript" src='<%# ResolveUrl("~/lib/jquery-ui/js/jquery-ui-1.8.16.custom.min.js") %>'></script>
      ...
      <script src='<%# ResolveUrl("~/lib/jquery/ui/development-bundle/ui/jquery.ui.core.js") %>' type="text/javascript"></script>
      <script src='<%# ResolveUrl("~/lib/jquery/ui/development-bundle/ui/jquery.ui.widget.js") %>' type="text/javascript"></script>
      <script type="text/javascript" src='<%# ResolveUrl("~/lib/jquery/ui/development-bundle/ui/jquery.ui.tabs.js") %>'></script>
      <script src='<%# ResolveUrl("~/lib/jquery/ui/development-bundle/ui/jquery.ui.mouse.js") %>' type="text/javascript"></script>
      <script src='<%# ResolveUrl("~/lib/jquery/ui/development-bundle/ui/jquery.ui.draggable.js") %>' type="text/javascript"></script>
    ...
    <link rel="stylesheet" href="<%# ResolveUrl("~/lib/pure/pure-min.css") %>" media="screen" />
    <link rel="stylesheet" href="<%# ResolveUrl("~/lib/pure/grids-responsive-min.css") %>" media="screen" />
    <!-- JULIE CSS -->
    <link rel="stylesheet" href="<%# ResolveUrl("~/App_Themes/Acuity3/css/app-1.0.16.css") %>" media="screen" />
    <script type="text/javascript" src="<%# ResolveUrl("~/applib/js/appLib-1.1.15.js?r=2") %>"></script>
...
<div class="ui-setup-form" style="display:none;">
    ...
    <div class="ui-setup-orphan-qsts" style="display:none;width:50%;margin-left:100px;">
...
<div class="ui-view ac-view" style="display:none;">
    ...
    <br /><textarea class="qst qst-comment" qst="TestCommentBox">Text Comment Box</textarea>
      ...
      <div style="display:none;">
        ...
        <asp:Label style="display:none;" id="lblQAEntryDate" runat="server"></asp:Label>
        ...
        <asp:Label ID="lblExaminer" runat="server"></asp:Label>
        ...
        <asp:Label ID="lblAgentTeamMembers" runat="server"></asp:Label>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./Quiz_base_1.js?r=45" language="javascript"></script>
<script type="text/javascript" src="../../../appLib/js/qa-1.0.3.js"></script>  </body>
</html>
