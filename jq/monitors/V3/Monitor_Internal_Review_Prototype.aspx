...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body runat="server" class="monitor-review-body">
            ...
            <tbody>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="242"  id="comment1" name="comment1" onkeyup="resizeTextarea('comment1')" data-resizable="true" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments"  qst="243" id="comment2" name="comment2" onkeyup="resizeTextarea('comment2')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" >
                  </textarea></td>
              </tr>
              <tr>
                <td>
                ...
                <td class="disposition">
                  <span class="mon-answer">
                    <select class="cheapscore qst" qst="246" score="16" af="Y">
                      <option value="">--select--</option>
                      <option selected="selected" value="Pass">Pass</option>
                      <option value="Fail">Fail</option>
                    </select>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="245" id="comment3" name="comment3" onkeyup="resizeTextarea('comment3')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="250" id="comment4" name="comment4" onkeyup="resizeTextarea('comment4')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="275" id="comment5" name="comment5" onkeyup="resizeTextarea('comment5')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="277" id="comment6" name="comment6" onkeyup="resizeTextarea('comment6')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="279" id="comment7" name="comment7" onkeyup="resizeTextarea('comment7')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="281" id="comment8" name="comment8" onkeyup="resizeTextarea('comment8')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="283" id="comment9" name="comment9" onkeyup="resizeTextarea('comment9')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="285" id="comment10" name="comment10" onkeyup="resizeTextarea('comment10')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" qst="287" id="comment11" name="comment11" onkeyup="resizeTextarea('comment11')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" ></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td style="background:white;">
                  <textarea class="qst qst-comments" id="comment12" qst="289" name="comment12" onkeyup="resizeTextarea('comment12')" type="text"  ng-disabled="readonly()"  ng-modelHOLD="f.Comment" >
                  </textarea>
                </td>
              </tr>
            </tbody>
              ...
              <tr>
                ...
                <td  rowspan="2" style="text-align: center;vertical-align:middle;">
                  ...
                  <div class="mon-show-reviewnotes" style="text-align: center;">
                    ...
                    <div style="margin-top:-8px;padding-top:0px; border-width:0px;margin-left:0px;">Tag: <input type="text" class="qst mon-field-trendcategory" qst="TrendCategory" style="width:400px;display:none;" /><a class="select-tag" style="margin-left:20px;text-decoration:underline;cursor:pointer;display:none;">select tag</a>
                        <select class="combo-tags" style="width:400px;"></select><a class="new-tag" style="margin-left:20px;text-decoration:underline;cursor:pointer;">new tag</a>
                    </div>
                  </div>
    ...
    <script type="text/javascript" src="./Monitor_Internal_Review_Prototype.js?r=18" language="javascript"></script>
  </body>
</html>
