<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_Toyota_v2.aspx.cs" ValidateRequest="false" Inherits="_Monitor_Toyota_v2" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head id="Head1" runat="server">
    <title>ACT Toyota V2 Scorecard</title>
  ...
  <body runat="server">
            ...
            <thead>
              <tr class="mon-table-header">
                <th rowspan="5" colspan="4" style="width: 55%;">
                  ...
                  <div class="heading">ACT Toyota Scorecard V2</div>
                </th>
              ...
              <tr>
                ...
                <td colspan="3">
                    <select  class="qst editable" qst="3a-flags" multiple="multiple" size="10">
                        ...
                        <option value="3a-7">3a-7: Outbound Call: Do not request the primary or co-x to provide any part of the SSN (Exception: WUSP)</option>
              ...
              <tr>
                ...
                <td colspan="3">
                    <select  class="qst editable" qst="3b-flags" multiple="multiple" size="23">
                        ...
                        <option value="3b-8">3b-8: INS: Agreement, application number or full VIN not obtained/verified</option>
                        <option value="3b-9">3b-9: LY- SL sent and Consent statement not delivered</option>
                        <option value="3b-10">3b-10: LY- SL sent by gaining consent from NSS</option>
                        <option value="3b-11">3b-11: LY- SL sent to originating dealer instead of mover dealership</option>
                        <option value="3b-12">3b-12: LY- SL sent without customer's affirmative response to consent</option>
                        <option value="3b-13">3b-13: NSS Relationship not obtained/verified</option>
                        <option value="3b-14">3b-14: PII: Provided to unauthorized NSS or unauthorized Third Party</option>
                        <option value="3b-15">3b-15: PII: Provided to other contract signer </option>
                        <option value="3b-16">3b-16: Providing account number without verifying additional information</option>
                        <option value="3b-17">3b-17: Providing the full Vehicle Identification Number (VIN) to the Customer</option>
                        <option value="3b-18">3b-18: Reciting the Account Holder's name to a Third Party or Non Signing Spouse (NSS)</option>
                        <option value="3b-19">3b-19: Reciting the Account Holder's name to the Customer prior to authentication</option>
                        <option value="3b-20">3b-20: Reciting the street name, number, apt. number, PO Box or more than the last two digits of the telephone number to the Customer, Co-Borrower, or Non Signing Spouse (NSS); unless provided by the Customer</option>
                        <option value="3b-21">3b-21: Reciting the website usernames, email addresses, and/or passwords</option>
                        <option value="3b-22">3b-22: Other</option>
                    </select>
                    <a class="mon-clear-select" title="Clear Selections">X</a>
                </td>
              </tr>
    ...
    <script type="text/javascript" src="./Monitor_Toyota_v2.js?r=10" language="javascript"></script>
  </body>
</html>
