<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_base_3.aspx.cs" ValidateRequest="false" Inherits="_Monitor_base_3" %>
  ...
  <div class="ui-view ac-view" style="display:none;">
    ...
    <!-- Header -->
      ...
      <div style="display:none;">
        ...
        <asp:Label ID="lblActionRequiredSupervisorName" runat="server"></asp:Label>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./Monitor_base_3.js?r=24t16" language="javascript"></script>
  </body>
</html>
