<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subform_base_1_dirty.aspx.cs" ValidateRequest="false" Inherits="_Subform_base_1_dirty" %>
...
<script type="text/javascript">
  (function () {
    ...
    <script type="text/javascript" src="./Subform_base_1_dirty.js?r=24" language="javascript"></script>
  </body>
</html>
