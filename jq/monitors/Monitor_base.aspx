<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_base.aspx.cs" ValidateRequest="false" Inherits="_Monitor_base" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="Monitor_base.css" />
  ...
  <body runat="server">
          ...
          <table class="mon-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td></td>
                <td>(C) Did the collector add the phone number to the DNC list when the borrower told them they did not want calls to a specified number?</td>
                <td ></td>
                <td >
    ...
    <script type="text/javascript" src="./Monitor_base.js?r=5" language="javascript"></script>
  </body>
</html>
