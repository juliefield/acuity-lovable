<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReportTableAsync.aspx.vb" ValidateRequest="false" Inherits="jq_ReportTableAsync" %>
...
<asp:PlaceHolder runat="server">
    ...
    <link href="appApmClient/themes/default/theme.css" type="text/css" rel="stylesheet" />
        ...
        <script type="text/javascript" src="appApmClient/js/appApmClientAsync.js"></script>
...
<body id="ReportTable" runat="server" style="position: relative;">
  ...
  <div id="container">
   <div id="header"><div id="brandingLogo"><h1><span>ERS</span></h1></div></div><div id="nav"><ul id="header_ul"><li><a onclick="return appLib.prefixhref(this);" href="http://acuityapm.com/default.aspx">Dashboard</a></li><li><a onclick="return appLib.prefixhref(this);" href="http://acuityapm.com/admin/admin.aspx">Admin</a></li><li><a onclick="return appLib.prefixhref(this);" href="http://acuityapm.com/monitor/monitor.aspx">Monitor</a></li><li id="header_liActive"><a id="header_active" onclick="return appLib.prefixhref(this);" href="http://acuityapm.com/report/quiz_review.aspx">Reports</a></li><li><a onclick="return appLib.prefixhref(this);" href="http://acuityapm.com/admin/import.aspx">Import</a></li><li><a onclick="return appLib.prefixhref(this);" href="http://acuityapm.com/admin/payroll.aspx">Payroll Admin</a></li></ul></div><div id="header_logout"><span>Welcome</span> <span id="header_userID_lbl"></span><span>&nbsp;| <a onclick="return appLib.prefixhref(this);" href='http://acuityapm.com/logout.aspx' title='Logout'>Logout</a></span><span style="color:gray;">&nbsp;&nbsp;v2</span></div><div id="sidebar"><div class="sidebarNav" id="ReportSidebar" runat = "server"></div></div></div>
      ...
      <div id="divMenu" style="position:relative;">
        <div class="filters" style="position: relative;">
          <div style="position:absolute; top: 5px; left: 10px;">
            ...
            <div id="comboprogress" style="z-index:2; position:absolute; top: 50px; left:40px;"></div>
    ...
    <div id="plotprogress" class="progressindicator" style="z-index:10; position:absolute; top: 250px; left:280px;display:none;"></div>
...
//        userDataOnFooter : true,
    ...
    var controlopts = {
        initfunction: function () {
            appApmClient.refreshboxes({ which: 'Project,Xaxis', del: function () { appApmClient.refreshboxes({ which: 'Location,Group,Team,CSR,KPI,Payperiod'}); } }); //This will set the project to the first project.
        ...
        pagecontrols: [
                { type: 'select', idtemplate: 'Project', onchange: function () { appApmClient.refreshboxes({ which: 'Location,Group,Team,CSR,Evaluator,Qualityform,Skillarea,Quizname,KPI' }) }, param: function () { return appApmClient.boxval('Project') } },
                { type: 'select', idtemplate: 'Location', onchange: function () { appApmClient.refreshboxes({ which: 'Group,Team,CSR,Evaluator' }) }, param: function () { return appApmClient.boxval('Location') } },
                { type: 'select', idtemplate: 'Group', onchange: function () { appApmClient.refreshboxes({ which: 'Team,CSR,Evaluator' }) }, param: function () { return appApmClient.boxval('Group') } },
                { type: 'select', idtemplate: 'Team', onchange: function () { appApmClient.refreshboxes({ which: 'CSR,Evaluator' }) }, param: function () { return appApmClient.boxval('Team') } },
                ...
                { type: 'select', idtemplate: 'Qualityform', onchange: function () { appApmClient.refreshboxes({ which: 'Skillarea' }) }, param: function () { return appApmClient.boxval('Qualityform') } },
                ...
                { type: 'select', idtemplate: 'Payperiod', onchange: function () { appApmClient.splitdates(document.getElementById('selPayperiods'), document.getElementById('spanDatefrom'), document.getElementById('spanDateto')); appApmClient.refreshboxes({ which: 'Evaluator' }); }, param: function () { return appApmClient.splitdateval('Payperiod') } },
