<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Monitor_ChatEmail_Prototype.aspx.cs" ValidateRequest="false" Inherits="_Monitor_ChatEmail_Prototype" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Chat/Email QA</title>
...
<div class="page-wrapper2">
  <div class="page-wrapper">
    ...
    <div class="header gradient-lightest">
        ...
        <div class="heading" style="margin-left:0px;margin-top:10px;">Chat/Email Quality Form</div>
    </div>
        ...
        <div class="mon-content">
          ...
          <ol>
             <li>
              ...
              <li>
                  <span class="mon-question">Pace/Flow and Grammar</span>
          ...
          <ol start="13">
              ...
              <li>
                  <span class="mon-question">Reminder &amp; Direction to Purchase PPP</span>
