<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TP1Report.aspx.vb" ValidateRequest="false" Inherits="jq_TP1Report" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if (true) { //ALWAYS DO THIS.  (appLib.gup("import3") != "") || (appLib.gup("cid") == "ImportLogRecords") || (appLib.gup("cid") == "ImportLogHeaders")) {
            $("#header").hide();
            $("#nav").hide();
            $("#header_logout").hide();
            $("#reportarea,#sidebar").css("top", "0px");
            $("#HeaderText").html("Import Logs");
            $("#reportsnav").append('<a href="import3.aspx">&lt; Return to Importer</a>');
        }
    });
</script>
</body>
