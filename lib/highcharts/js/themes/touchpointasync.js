...
Highcharts.theme = {
    ...
    yAxis: {
        ...
        plotBands: [
        //{ color: 'red', from: 0, to: 0.05 },
        //{ color: 'yellow', from: 4, to: 4.05 },
        //{ color: 'green', from: 8, to: 8.05 }
            {color: 'white', from: 3.98, to: 4.02 },
            { color: 'white', from: -0.04, to: 0.00 },
            { color: 'white', from: 7.98, to: 8.02 }
        ]
    },
    legend: {
        itemStyle: {
