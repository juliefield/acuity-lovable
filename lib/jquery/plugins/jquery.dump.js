jQuery.fn.dump = function (par) {
    if (!par) par = new Object();
    par.object = $(this);
    jQuery.dump(par);
    return this;
};

var dump_hasappended = false;
jQuery.dump = function (par) {
    //(object, showTypes, showAttributes) {
    /* {
    object: //object to dump
    showTypes:
    showAttributes:
    winName: //Window Name
    targetDiv: //target div (if undefined, will dump to popup window)
    width: //width of target div
    height: //height of target div
    } */
    var object = par.object;
    var dump = '';
    var st = typeof par.showTypes == 'undefined' ? false : par.showTypes;
    var sa = typeof par.showAttributes == 'undefined' ? true : par.showAttributes;
    var winName = typeof par.winName == 'undefined' ? 'dumpWin' : par.winName;
    var w = typeof par.width == 'undefined' ? 760 : par.width;
    var h = typeof par.height == 'undefined' ? 500 : par.height;
    ...
    var mytd = "";
    if (!par.targetDiv) { } else { mytd = par.targetDiv };
