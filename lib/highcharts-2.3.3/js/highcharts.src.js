...
var VMLRendererExtension = { // inherit SVGRenderer
	...
	init: function (container, width, height) {
		...
		if (!doc.namespaces.hcv) {
			...
			// setup default css
            /* //DUCK UPDATE: TODO: DONE: HACK:   I removed this and it WORKS!
...
Chart.prototype = {
	...
	cloneRenderTo: function (revert) {
		...
		// Set up the clone
			...
			if (container) {
			    discardElement(container); //CHANGED BY JEFF GACK DUCK 
                //WAS THIS: this.renderTo.removeChild(container); // do not clone this
			}
