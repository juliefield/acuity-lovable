<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JournalList.aspx.cs" ValidateRequest="false" Inherits="three_JournalList" %>
...
<body id="Body1" class="journal-list" runat="server" ng-controller="legacyController">
    <div ng-legacy-container class="content">
        <h1>Agent List</h1>
        <p>Select an agent from the list below or from the CSR Filter on the left. </p>
        <div ng-form-list></div>
    </div>
</body>
