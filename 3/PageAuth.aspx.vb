                ...
                Using db As New DbBaseSql(_connection)
                    ...
                    If authenticated Then
                        ...
                        If Not ClientScript.IsStartupScriptRegistered("authscript") Then
                            ...
                            'The URL is really the rest of the string.
                            'Dim url As String = Request.QueryString("url")
                            Dim url As String = ""
                            If (Request.RawUrl.IndexOf("?url=") >= 0) Then
                                url = Request.RawUrl.Substring(Request.RawUrl.IndexOf("?url=") + 5)
                            ElseIf (Request.RawUrl.IndexOf("&url=") >= 0) Then
                                url = Request.RawUrl.Substring(Request.RawUrl.IndexOf("&url=") + 5)
                            End If
