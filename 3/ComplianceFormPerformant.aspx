<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComplianceFormPerformant.aspx.cs" ValidateRequest="false" Inherits="three_ComplianceFormPerformant" %>
...
<html xmlns="http://www.w3.org/1999/xhtml"  ng-app="angularApp">
   <head id="Head1" runat="server">
      ...
      <asp:PlaceHolder runat="server">
         ...
         <script type="text/javascript" src="../appLib/dev/COMPLIANCE1/COMPLIANCE1-vm/complianceMonitoringPerformant.js?<%=CONFMGR.Bump()%>"></script>
      </asp:PlaceHolder>
      ...
      <div ng-legacy-container class="content" style="width:100%;height:100%;overflow-y: scroll; position:relative;">
        ...
        <div class="tabs" style="position:relative;" id="tabscompliance">
          <ul>
            ...
            <li><a class="tablabel compliance-monitor-link" id="monitortab" href="#tabs-monitor">Coaching Form</a></li>
            ...
            <!-- <li style="color:white;position:absolute;right:10px;top:5px;font-size:12px;">(Development Site)</li> -->
          	...
          	<div class="compliance-noaccess-message" style="font-size:16px;font-weight:bold; margin:50px;display:none;text-align: center; width: 100%;margin-top:30px;">
          		...
          		<br />Please contact Charles Isaacson for details.
          	</div>
          	<!--
