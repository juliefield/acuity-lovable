<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Userprofile.aspx.cs" ValidateRequest="false" Inherits="three_Userprofile" %>
...
<html xmlns="http://www.w3.org/1999/xhtml"  ng-app="angularApp">
   <head id="Head1" runat="server">
      ...
      <asp:PlaceHolder runat="server">
         ...
         <script type="text/javascript" src="../appLib/js/applib.js?r=4"></script>
        ...
        <script type="text/javascript" src="../jq/appApmClient/js/appApmContentTriggers-1.0.js?r=3"></script>
         ...
         <script type="text/javascript" src="../applib/js/profile-ui-scripts.js?<%=CONFMGR.Bump()%>"></script>
