...
public partial class three_ComplianceFormPerformant : SitePage
{
...
//            Session("TP1Role") = Request.QueryString("role").ToString
        ...
        if ((Session["TP1Role"] != null) && (Session["TP1Username"] != null) && (Request.QueryString["origin"] == null))
        {
        ...
        {
            //ADDED 2018-06-10 - Carry prtuid with the login redirect.
            String redirect = "~/applib/dev/LOGIN1/LOGIN1-view/loginNew.aspx?url=/3/ComplianceFormPerformant.aspx";
            if (Request.QueryString["prtuid"] != null)
            {
                redirect += "|prtuid=" + Request.QueryString["prtuid"];
            }
