<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgameFlex.aspx.cs" Inherits="_3_AgameFlex" %>
      ...
      <asp:PlaceHolder runat="server">
        ...
        <script type="text/javascript" src="../jq/appApmClient/js/appApmContentTriggers-1.0.js?r=3"></script>
         ...
         <script type="text/javascript" src="../appLib/js/services/mainServices.js?<%=CONFMGR.Bump()%>"></script>
    	  ...
    	  <script type="text/javascript" src="../appLib/dev/AGAMEFLEX1/vm/agameflex.js?<%=CONFMGR.Bump()%>"></script>

      </asp:PlaceHolder>

   </head>
   <body id="Body1" style="position:relative;overflow-y:scroll;" runat="server" ng-controller="legacyController">
