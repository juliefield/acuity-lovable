...
public partial class three_SupPerfMgt : SitePage
{
...
//            Session("TP1Role") = Request.QueryString("role").ToString
        ...
        else
        {
            ...
            if (Request.RawUrl.IndexOf("?") >= 0)
            {
                rest = "?" + Request.RawUrl.Substring(Request.RawUrl.IndexOf("?") + 1);
            }

            //Request.RawUrl.Split("?")(1)
            String redirect = "~/applib/dev/LOGIN1/LOGIN1-view/loginNew.aspx?url=../../../../3/SupPerfMgt.aspx" + rest;
