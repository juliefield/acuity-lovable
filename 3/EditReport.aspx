<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditReport.aspx.cs" ValidateRequest="false" Inherits="three_EditReport" %>
...
<html xmlns="http://www.w3.org/1999/xhtml"  ng-app="angularApp">
   ...
   <body id="Body1" style="position:relative;overflow-y:scroll;" class="journal-panel" runat="server" ng-controller="legacyController">
      <form id="form1" runat="server"></form> <!-- This form was causing sizing issues in the iframe, so I emptied it (not sure I need it). -->
                  	<ng-acuity-filter-button-toggle
                  		assoc="journal-touch-count"
                  		text1="Current Month" params1="StartDate={Date,Month,Start,0}&EndDate={Date,Month,End,0}"
                  		text2="Last Month" params2="StartDate={Date,Month,Start,-1}&EndDate={Date,Month,End,-1}"
                  	>
                  	</ng-acuity-filter-button-toggle>

                  	<ng-acuity-report-bar-select assoc="ALL">
      ...
      <div ng-legacy-container class="content" style="width:100%;height:100%; position:relative;">
          ...
          <ng-acuity-report text="Report Editor" details="Place all parameters on the command line."
   			hidetopper="false" class="report-box" filters="URL" cidclient="all">
       	</ng-acuity-report>
      </div>
    <script language="javascript">
        /*
        alert("debug: CSR=" + $.cookie("CSR"));
        alert("debug: Team=" + $.cookie("Team"));
