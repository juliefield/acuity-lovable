<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        <title>Acuity - Goal/Task Manager</title>
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="js/goalTaskManagerPage.js?<%=CONFMGR.Bump()%>"></script>
            ...
            <script type="text/javascript" src="../../../appLib/dev/GOALTASK1/vm/userGoalManager.js?<%=DevBumper%>"></script>
            <script type="text/javascript" src="../../../appLib/dev/GOALTASK1/vm/userTaskManager.js?<%=CONFMGR.Bump()%>"></script>
        ...
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">
                ...
                <div class="user-dashboard_tabs">                    
                    <div class="tab">
                        <button id="goalsTab" class="tablinks">Manage Goals</button>
                        <button id="tasksTab" class="tablinks">Manage Tasks</button>
                    </div>
                    <div>
                        <a class="btn-goal-task-back" onclick="window.history.back();return false;">&#171; Back</a>
                    </div>
                    <br />
                    <div id="goalsContainer" class="tabcontent">
                        <ng-user-goal-manager displaylimiteddata="false"></ng-user-goal-manager>
                    </div>
                    <div id="tasksContainer" class="tabcontent">
