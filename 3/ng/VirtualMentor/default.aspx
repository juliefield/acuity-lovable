<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script src="../../../lib/highcharts-8.2.0/code/highcharts-more.js?<%=CONFMGR.Bump()%>"></script>
            <script src="../../../lib/highcharts-8.2.0/code/modules/solid-gauge.js?<%=CONFMGR.Bump()%>"></script>
            ...
            <script src="./js/virtualMentor.js?<%=DevBumper%>"></script>
            <!-- Login -->
        ...
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">
                ...
                <div style="max-height:80vh;min-height:80vh;overflow:auto;">
                    <div style="border:1px solid black;min-height:250px;max-width:24vw;display:inline-block;">
                        <div id="totalPieContainer"></div>
                    </div>
                    <div style="border:1px solid blue;min-height:250px;max-width:24vw;display:inline-block;">
                        <div id="coachingPieChart"></div>
                    </div>
                    <div style="border:1px solid lime;min-height:250px;max-width:24vw;display:inline-block;">
                        <div id="recognitionPieChart"></div>
                    </div>
                    <div style="border:1px solid cyan;min-height:250px;max-width:24vw;display:inline-block;">
                        <div id="mqfCoachPieChart"></div>
                    </div>
                    <div style="border:1px solid red;min-height:250px;max-width:90vw;">
                        <div id="totalActivityContainer"></div>
                    </div>
                </div>
