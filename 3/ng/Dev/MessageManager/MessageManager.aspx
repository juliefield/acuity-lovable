<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MessageManager.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../../appLib/dev/DEVAREA1/vm/messageManager.js?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>            
            <link rel="stylesheet" href="../../../../lib/jquery-ui/development-bundle/themes/base/jquery.ui.all.css" />                                    
            <link rel="stylesheet" href="css/message-manager-styles.css?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>" />            
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>
            ...
            <div>
                <ng-message-manager></ng-message-manager>
            </div>
        </ng-legacy-container>
    </body>
