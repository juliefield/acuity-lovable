<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfigParameterManager.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        <title>Config Parameter Manager</title>
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../appLib/dev/ACUITYADMIN1/vm/configParameterManager.js?<%=DateTime.Now.Minute.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>
