<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelfServiceSetup.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        <title>Self Service Setup</title>
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../appLib/dev/DEVAREA1/vm/selfservicesetup.js?<%=DateTime.Now.Minute.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">                
                <ng-self-service-setup></ng-self-service-setup>
            </section>
        </ng-legacy-container>
    </body>
