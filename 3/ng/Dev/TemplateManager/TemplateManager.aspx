<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TemplateManager.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../../appLib/dev/DEVAREA1/vm/templateManager.js?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>            
            <link rel="stylesheet" href="../../../../lib/jquery-ui/development-bundle/themes/base/jquery.ui.all.css" />                                    
            <link rel="stylesheet" href="css/templateManagerStyles.css" />            
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>
            ...
            <div>
                <ng-template-manager></ng-template-manager>
            </div>
        </ng-legacy-container>
    </body>
