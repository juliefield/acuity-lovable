<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserManager.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../appLib/dev/USERPROFILE1/vm/userProfileExtended.js?<%=DevBumper%>"></script>
            <!-- <script type="text/javascript" src="../../../applib/anothercolorpicker/src/jquery.simple-color.js?<%=CONFMGR.Bump()%>"></script> -->
            <link rel="stylesheet" href="../../../applib/css/variables.css?<%=CONFMGR.Bump()%>" />            
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>            
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">
                <ng-user-profile-extended></ng-user-profile-extended>
            </section>
        </ng-legacy-container>
    </body>
