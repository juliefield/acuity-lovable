<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuizAdmin.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld"
  %>
  <!DOCTYPE html
  ...
  <head id="Head1" runat="server">
    ...
    <asp:PlaceHolder runat="server">
      ...
      <script type="text/javascript" src="../../../appLib/dev/Quizing/vm/quizQuestionManagement.js?<%=DevBumper%>"></script>
      <!-- HighCharts START -->
    ...
    <ng-legacy-container>
      ...
      <section class="acuity-app" ng-show="LOGGED_IN()">
        ...
        <div>
            Quiz Admin Here.
            <hr>
            <a href="default.aspx">Quiz Dashboard</a><br>
