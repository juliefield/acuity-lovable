<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="js/agameAdminPage.js?<%=DevBumper%>"></script>
            ...
            <script type="text/javascript" src="../../../appLib/dev/AGAMEADMIN1/vm/agameadmin.js?<%=CONFMGR.Bump()%>"></script>
            <script type="text/javascript" src="../../../appLib/dev/AGAMEADMIN1/vm/agameXtremeAdmin.js?<%=DevBumper%>"></script>
        ...
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">
                ...
                <div class="tabsHolder">
                    <div class="tab">
                       <button id="currentGamesTab" class="tablinks active">Current Standard Game</button>
                       <!-- <button id="pastGamesTab" class="tablinks">Past Games</button> -->                       
                       <button id="currentXtremeTab" class="tablinks">Current xTreme Game</button>
                    </div>
                </div>
                <div id="currentGameContainer">
                    <ng-agame-admin></ng-agame-admin>
                </div>
                <!-- <div id="pastGamesContainer">
                    Past Games Will Show Here.  This has not yet been created.
                </div> -->
                <div id="currentXtremeContainer">
                    <ng-agame-xtreme-admin></ng-agame-xtreme-admin>                    
                </div>
            </section>            
        </ng-legacy-container>
    </body>
