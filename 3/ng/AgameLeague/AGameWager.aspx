<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AGameWager.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        <title>A-GAME Wager - Development Section</title>
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../appLib/dev/AGAMELEAGUES1/vm/aGameLeagueWager.js?<%=DevBumper%>"></script>
            <link href="./css/agameWager.css?<%=DevBumper%>" rel="stylesheet">
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">                                
                <ng-agame-league-wager></ng-agame-league-wager>
            </section>
        </ng-legacy-container>
    </body>
