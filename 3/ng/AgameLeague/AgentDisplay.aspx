<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgentDisplay.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml" ng-app="angularApp">

    <head id="Head1" runat="server">
        <title>A-GAME Leagues: Agent Display</title>
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../appLib/dev/AGAMELEAGUES1/vm/userAgameLeagueViewFull.js?<%=CONFMGR.Bump()%>"></script>
            <link rel="stylesheet" href="../UserDashboard/css/user-dashboard-styles.css" />
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">
                ...
                <div class="matchup-large" style="overflow:auto;max-height:90vh;">
                    <ng-agame-wager-widget></ng-agame-wager-widget>
                    <ng-user-agame-league-view-full></ng-user-agame-league-view-full>
                    <script>
