<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xTremeLeaderboard.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        ...
        <asp:PlaceHolder runat="server">
            ...
            <link rel="stylesheet" href="../AcuityAdmin/css/acuity-admin.css?<%=CONFMGR.Bump()%>" />
            <link rel="stylesheet" href="../UserDashboard/css/user-dashboard-styles.css?<%=CONFMGR.Bump()%>" />
        </asp:PlaceHolder>
        <style>
        </style>
    </head>
