  /*
                              ...
                              * Demo: https://codepen.io/goker/pen/nyXeVV
                              */
  ...
  (function($) {
   ...
   Plugin.prototype = {
       init: function() {
         ...
         _intervalId.push(setInterval($.proxy(this.refresh, this), 1000));
   ...
   $.fn[pluginName].stop = function() {
      _intervalId.forEach(function(intervalId){
         clearInterval(intervalId);         
      });
      _intervalId.length = 0;
   };

   })(typeof jQuery !== 'undefined' ? jQuery : alert(`jQuery Required to function.`));


   // // RUN
   // $('.countdown-container').flipclock('2024 01 17 12:00:00');