<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userGameListing.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        <title>Flex Game - User Game Listings</title>
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../lib/jquery-sparkline/jquery.sparkline.min.js?<%=CONFMGR.Bump()%>"></script>
            ...
            <!-- <script type="text/javascript" src="../../../appLib/dev/AGAMEFLEX1/vm/agameflexgamelisting.js?<%=CONFMGR.Bump()%>"></script> -->
            <script type="text/javascript" src="../../../appLib/dev/AGAMEFLEX1/vm/agameflexgamelisting.js?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>
            <script type="text/javascript" src="../../../appLib/dev/AGAMEFLEX1/vm/agameflexListAll.js?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>
            ...
            <script type="text/javascript" src="/appLib/dev/MESSAGING1/MESSAGING1-vm/MESSAGING.js?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>

            <link rel="stylesheet" href="css/agame-flex-styles.css?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>" />
            <link rel="stylesheet" href="/applib/dev/MESSAGING1/MESSAGING1-view/messaging.css?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>" />
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">
                ...
                <ng-agame-flex-game-list></ng-agame-flex-game-list>
            </section>
        </ng-legacy-container>
    </body>
