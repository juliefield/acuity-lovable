<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AGameFlexAnimation.aspx.cs" ValidateRequest="false"
    Inherits="AGameFlexAnimation" %>
    <!DOCTYPE html
        PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml" ng-app="angularApp">

    <head runat="server">
        <title>Flex Game - Animations</title>
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript"
                src="../../../appLib/dev/AGAMEFLEX1/vm/agameFlexAnimations.js?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>
            <link rel="stylesheet"
                href="../../../lib/jquery-ui/development-bundle/themes/base/jquery.ui.all.css?<%=CONFMGR.Bump()%>" />
            <link rel="stylesheet" href="css/agame-flex-styles.css?<%=CONFMGR.Bump()%>" />
            <link rel="stylesheet" href="css/agame-flex-animation-styles.css?<%=CONFMGR.Bump()%>" />
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">
                ...
                <ng-agame-flex-animations></ng-agame-flex-animations>
            </section>
        </ng-legacy-container>agameflex
    </body>
