<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FlexScoringAreaManager.aspx.cs" ValidateRequest="false" Inherits="_HelloWorld" %>
    ...
    <head id="Head1" runat="server">
        ...
        <asp:PlaceHolder runat="server">
            ...
            <script type="text/javascript" src="../../../appLib/dev/AGAMEFLEX1/vm/agameflexScoringAreaManager.js?<%=DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Hour.ToString() +  DateTime.Now.Minute.ToString() +  DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString()%>"></script>
    ...
    <body ng-controller="legacyController">
        <ng-legacy-container>
            ...
            <section class="acuity-app" ng-show="LOGGED_IN()">
                ...
                <ng-agame-flex-scoring-area-manager></ng-agame-flex-scoring-area-manager>
            </section>
        </ng-legacy-container>
    </body>
